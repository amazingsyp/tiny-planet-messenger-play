...
`;function _u(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.3,`rgba(255,250,230,0.9)`),n.addColorStop(1,`rgba(255,250,230,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Ni(e)}var vu=class{group=new wn;sunDirection=new W(.55,.72,.42).normalize();stars;starMaterial;domeMaterial;constructor(e=170){this.domeMaterial=new ea({uniforms:{topColor:{value:new q($.skyZenith)},midColor:{value:new q($.skyMid)},botColor:{value:new q($.skyHorizon)},sunColor:{value:new q($.sunGlow)},sunDir:{value:this.sunDirection}},vertexShader:hu,fragmentShader:gu,side:1,depthWrite:!1,fog:!1});let t=new Y(new Wi(e,32,24),this.domeMaterial);t.renderOrder=-1,this.group.add(t);let n=new Float32Array(720*3),r=new Float32Array(720*3),i=Jl(22436),a=new q($.star),o=new q(12571903),s=new q,c=e*.92;for(let e=0;e<720;e++){let t=Xl(i);n[e*3]=t.x*c,n[e*3+1]=t.y*c,n[e*3+2]=t.z*c,s.copy(a).lerp(o,i()*.6),r[e*3]=s.r,r[e*3+1]=s.g,r[e*3+2]=s.b}let l=new Er;l.setAttribute(`position`,new J(n,3)),l.setAttribute(`color`,new J(r,3)),this.starMaterial=new Ti({size:2.2,map:_u(),vertexColors:!0,transparent:!0,depthWrite:!1,sizeAttenuation:!1,blending:2}),this.stars=new Ai(l,this.starMaterial),this.stars.renderOrder=-1,this.group.add(this.stars)}update(e,t){this.stars.rotation.y+=e*.006,this.starMaterial.opacity=.65+.3*Math.sin(t*.7)}},yu=`An original prototype — every shape, colour, and line of code is generated from primitives in this repository. No third-party game assets, source, or layouts are used or copied. Not affiliated with any existing game.`;function bu(e,t={}){let n=document.createElement(e);return t.className&&(n.className=t.className),t.id&&(n.id=t.id),t.html!==void 0&&(n.innerHTML=t.html),n}var xu=class{onStart=()=>{};onReplay=()=>{};overlay;card;hud;objectiveText;objectiveHint;countDone;countTotal;compass;needle;dist;toast;touch;fwd=!1;back=!1;left=!1;right=!1;toastTimer=0;constructor(e){this.card=bu(`div`,{className:`card`}),this.overlay=bu(`div`,{className:`overlay`,id:`overlay`}),this.overlay.appendChild(this.card),this.hud=bu(`div`,{id:`hud`}),this.hud.appendChild(bu(`div`,{className:`hud-panel`,id:`hud-objective`,html:`<div class="label-tiny">Objective</div><div id="objective-text">Getting ready…</div><div id="objective-hint"></div>`})),this.hud.appendChild(bu(`div`,{className:`hud-panel`,id:`hud-count`,html:`<div class="label-tiny">Delivered</div><div id="count-value"><span id="count-done">0</span><span class="total" id="count-total">/3</span></div>`})),this.compass=bu(`div`,{id:`compass`,html:`<div class="ring"></div><div class="needle" id="needle"></div><div class="dist" id="dist">--</div>`}),this.toast=bu(`div`,{id:`toast`}),this.touch=bu(`div`,{id:`touch`,html:`<button class="touch-btn" id="t-fwd" aria-label="forward">▲</button><button class="touch-btn" id="t-back" aria-label="back">▼</button><button class="touch-btn" id="t-left" aria-label="left">◀</button><button class="touch-btn" id="t-right" aria-label="right">▶</button>`});let t=bu(`div`,{className:`hint`,html:`WASD / arrow keys to move • reach the glowing mailbox to deliver`});e.append(this.overlay,this.hud,this.compass,this.toast,this.touch,t),this.objectiveText=this.req(`objective-text`),this.objectiveHint=this.req(`objective-hint`),this.countDone=this.req(`count-done`),this.countTotal=this.req(`count-total`),this.needle=this.req(`needle`),this.dist=this.req(`dist`),this.bindTouch(),window.matchMedia(`(pointer: coarse)`).matches&&document.body.classList.add(`touch`)}get touchMove(){return!!this.fwd-+!!this.back}get touchTurn(){return!!this.right-+!!this.left}get overlayVisible(){return!this.overlay.classList.contains(`hidden`)}showStart(){this.card.innerHTML=`<div class="art-preview"><img src="./concept-art.jpg" alt="Tiny planet courier concept art" /></div><h1>Tiny Planet Messenger</h1><div class="subtitle">A cozy courier run on a little world</div><p>Three parcels are waiting. Hop around your tiny planet and drop each one at its glowing mailbox. Follow the compass at the bottom of the screen.</p><div class="controls"><span class="key"><kbd>W</kbd><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd> / arrows — walk &amp; turn</span><span class="key"><kbd>Enter</kbd> — start</span></div><button class="btn" id="start-btn">Start delivering</button><p class="fine-print">${yu}</p>`,this.overlay.classList.remove(`hidden`),this.card.querySelector(`#start-btn`)?.addEventListener(`click`,()=>this.onStart())}showComplete(e,t){this.card.innerHTML=`<h1>All delivered! 🎉</h1><div class="subtitle">Tiny Planet Messenger</div><p>You delivered all ${e} parcels in <strong>${t}</strong>. The little world thanks you.</p><button class="btn" id="replay-btn">Play again</button>`,this.overlay.classList.remove(`hidden`),this.card.querySelector(`#replay-btn`)?.addEventListener(`click`,()=>this.onReplay())}hideOverlay(){this.overlay.classList.add(`hidden`)}showHud(e){this.hud.classList.toggle(`show`,e)}showCompass(e){this.compass.classList.toggle(`show`,e)}activateTouch(){this.touch.classList.add(`active`)}setObjective(e,t){this.objectiveText.textContent=e,this.objectiveHint.textContent=t}setCount(e,t){this.countDone.textContent=String(e),this.countTotal.textContent=`/${t}`}updateCompass(e,t){this.needle.style.transform=`translate(-50%, -100%) rotate(${e}deg)`,this.dist.textContent=`${Math.round(t)}m`}showToast(e){this.toast.textContent=e,this.toast.classList.add(`show`),window.clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>{this.toast.classList.remove(`show`)},1600)}req(e){let t=document.getElementById(e);if(!t)throw Error(`UI element #${e} missing`);return t}bindTouch(){let e=(e,t)=>{let n=this.req(e),r=e=>{e.preventDefault(),t(!0)},i=()=>t(!1);n.addEventListener(`pointerdown`,r),n.addEventListener(`pointerup`,i),n.addEventListener(`pointerleave`,i),n.addEventListener(`pointercancel`,i)};e(`t-fwd`,e=>this.fwd=e),e(`t-back`,e=>this.back=e),e(`t-left`,e=>this.left=e),e(`t-right`,e=>this.right=e)}},Su=Yl(-12,104),Cu=[{name:`Harbor Post`,dir:Yl(-28,122)},{name:`Hill Shrine`,dir:Yl(42,6)},{name:`Forest Mill`,dir:Yl(58,-88)}];function wu(e){return Math.max(-1,Math.min(1,e))}function Tu(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}var Eu=class{renderer;scene=new Nn;camera=new Pa(48,1,.1,500);clock=new eo;keyboard=new Pl;ui;sky=new vu;planet=new du;player=new fu(Su);quests=new mu(Cu);tmp=new W;tmp2=new W;camTarget=new W;lookTarget=new W;running=!1;playing=!1;elapsed=0;playStartedAt=0;root;constructor(e){this.root=e,this.renderer=new yl({antialias:!0,alpha:!1}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setClearColor($.skyZenith,1),this.scene.background=new q($.skyZenith),this.scene.fog=new Mn($.skyZenith,.012),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.root.appendChild(this.renderer.domElement),this.ui=new xu(e),this.ui.onStart=()=>this.beginRun(),this.ui.onReplay=()=>this.beginRun(),this.buildScene(),this.bindEvents(),this.resize(),this.updateHud(),this.ui.showStart()}start(){this.running||(this.running=!0,this.clock.start(),this.renderer.setAnimationLoop(()=>this.frame()))}dispose(){this.running=!1,this.renderer.setAnimationLoop(null),this.keyboard.dispose(),window.removeEventListener(`resize`,this.resize),this.renderer.dispose()}buildScene(){this.scene.add(this.sky.group);let e=new Sa($.hemiSky,$.hemiGround,2.1);this.scene.add(e);let t=new La($.sunLight,4.2);t.position.copy(this.sky.sunDirection).multiplyScalar(60),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.near=5,t.shadow.camera.far=140,t.shadow.camera.left=-28,t.shadow.camera.right=28,t.shadow.camera.top=28,t.shadow.camera.bottom=-28,this.scene.add(t),this.scene.add(this.planet.group),this.scene.add(this.quests.group),this.scene.add(this.player.group),this.planet.scatter(Jl(11256099),[Su,...Cu.map(e=>e.dir)],82),this.placeAuthoredDetails(),this.placeCamera(1)}placeAuthoredDetails(){let e=[{dir:Cu[0].dir,make:Ol,spin:-.35,scale:1.35},{dir:Cu[1].dir,make:kl,spin:.55,scale:1.25},{dir:Cu[2].dir,make:Al,spin:.1,scale:1.2}];for(let t of e){let e=t.make();e.scale.setScalar(t.scale),Zl(e,t.dir,bl.planetRadius+.025,t.spin),this.scene.add(e)}for(let e=0;e<9;e++){let t=e/8,n=Su.clone().lerp(Cu[0].dir,t).normalize(),r=jl();r.scale.setScalar(.85+t*.25),Zl(r,n,bl.planetRadius+.035,-.4+t*1.1),this.scene.add(r)}let t=[Yl(7,-43),Yl(18,-48),Yl(2,-76),Yl(-10,-36),Yl(16,25),Yl(-8,130)];for(let e of t){let t=Ml();t.scale.setScalar(1.35),Zl(t,e,bl.planetRadius+.04,Math.random()*Math.PI),this.scene.add(t)}}bindEvents(){window.addEventListener(`resize`,this.resize),window.addEventListener(`keydown`,e=>{e.code===`Enter`&&this.ui.overlayVisible&&(e.preventDefault(),this.beginRun())})}resize=()=>{let e=Math.max(1,this.root.clientWidth||window.innerWidth),t=Math.max(1,this.root.clientHeight||window.innerHeight);this.camera.aspect=e/t,this.camera.fov=e<700?58:48,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1)};beginRun(){this.player.reset(Su),this.quests.reset(),this.elapsed=0,this.playStartedAt=this.clock.elapsedTime,this.playing=!0,this.ui.hideOverlay(),this.ui.showHud(!0),this.ui.showCompass(!0),this.ui.activateTouch(),this.ui.showToast(`First parcel loaded — follow the glow!`),this.updateHud(),this.placeCamera(1)}frame(){let e=Math.min(this.clock.getDelta(),.04);if(this.elapsed=this.clock.elapsedTime,this.sky.update(e,this.elapsed),this.playing){let t=wu(this.keyboard.move+this.ui.touchMove),n=wu(this.keyboard.turn+this.ui.touchTurn);this.player.update(e,t,n);let r=this.quests.update(this.player.position,e,this.elapsed);r&&(this.ui.showToast(`Delivered to ${r.name}!`),this.updateHud(),this.quests.complete&&(this.playing=!1,this.ui.showComplete(this.quests.total,Tu(this.clock.elapsedTime-this.playStartedAt)),this.ui.showCompass(!1))),this.updateCompass()}this.placeCamera(e),this.renderer.render(this.scene,this.camera)}placeCamera(e){let t=e>=1?1:1-Math.exp(-bl.camLerp*e);this.camTarget.copy(this.player.position).addScaledVector(this.player.up,bl.camHeight).addScaledVector(this.player.forward,-bl.camDistance),this.camera.position.lerp(this.camTarget,t),this.lookTarget.copy(this.player.position).addScaledVector(this.player.up,1.55).addScaledVector(this.player.forward,bl.camLookAhead),this.camera.up.copy(this.player.up),this.camera.lookAt(this.lookTarget)}updateHud(){let e=this.quests.active();e?this.ui.setObjective(`Deliver parcel to ${e.name}`,`Look for the glowing mailbox beacon.`):this.ui.setObjective(`All routes complete`,`Replay to run the route again.`),this.ui.setCount(this.quests.delivered,this.quests.total)}updateCompass(){let e=this.quests.active();if(!e||(this.tmp.copy(e.dir).addScaledVector(this.player.up,-e.dir.dot(this.player.up)),this.tmp.lengthSq()<1e-6))return;this.tmp.normalize();let t=Et.clamp(this.tmp.dot(this.player.forward),-1,1),n=this.tmp.dot(this.player.right),r=Et.radToDeg(Math.atan2(n,t)),i=this.player.up.angleTo(e.dir)*bl.planetRadius;this.tmp2.copy(e.position).sub(this.player.position);let a=Math.min(i,this.tmp2.length());this.ui.updateCompass(r,a)}},Du=document.querySelector(`#app`);if(!Du)throw Error(`Missing #app mount point`);new Eu(Du).start();