...
`;function Hu(e,t=.04,n=Lu){let r=new vo({uniforms:{thickness:{value:t},outlineColor:{value:new K(n)}},vertexShader:Bu,fragmentShader:Vu,side:1}),i=new q(e.geometry,r);return i.castShadow=!1,i.receiveShadow=!1,i.userData.isOutline=!0,i.renderOrder=(e.renderOrder??0)-1,e.add(i),i}function Uu(e,t=.04,n=Lu){let r=[];e.traverse(e=>{let t=e;t.isMesh&&!e.userData.isOutline&&r.push(t)});for(let e of r)Hu(e,t,n)}var $={skyZenith:6472637,skyHorizon:9165011,skyMid:4893101,sunGlow:16773577,sunLight:16774364,hemiSky:14283759,hemiGround:6063197,ambient:5991050,land:5218919,landDark:3116120,highland:7649148,sand:5218919,water:6472637,waterDeep:4893101,trunk:10251074,leaf:6270554,leafAlt:8309099,houseWall:15921120,houseWallAlt:14276552,roofA:13987674,roofB:6981316,roofC:13208245,door:8016438,pathRing:15324840,cloud:16645375,star:16774872,courierBody:4161494,courierBag:13128764,courierSkin:15910810,courierHat:3108751,beacon:16765503,beaconDone:9429896,markerRing:16773288};function Wu(){let e=new G,t=Q({color:12158293}),n=Q({color:15982519}),r=Q({color:$.roofA}),i=new q(new J(3,.18,1.05),t);i.position.set(0,.12,.15),i.castShadow=i.receiveShadow=!0,e.add(i);for(let t of[-1.25,-.35,.55,1.35]){let n=new q(new J(.1,.08,1.18),Q({color:13934699}));n.position.set(t,.27,.15),n.castShadow=!0,e.add(n)}for(let n of[-1.35,1.35]){let i=new q(new zi(.09,.11,.9,7),t);i.position.set(n,.55,-.48),i.castShadow=!0,e.add(i);let a=new q(new so(.16,8,6),r);a.position.set(n,1.04,-.48),a.castShadow=!0,e.add(a)}let a=new q(new J(1.15,.28,.42),Q({color:6200278}));a.position.set(.3,.38,.95),a.rotation.z=.08,a.castShadow=!0,e.add(a);let o=new q(new Bi(.38,.9,3),n);return o.position.set(.34,.95,.93),o.rotation.y=Math.PI/6,o.castShadow=!0,e.add(o),Uu(e,.026),e}function Gu(){let e=new G,t=Q({color:14241085}),n=Q({color:16771003}),r=Q({color:10920631}),i=new q(new J(1.9,.18,1.45),r);i.position.y=.12,i.castShadow=i.receiveShadow=!0,e.add(i);for(let n of[-.72,.72]){let r=new q(new zi(.11,.14,1.6,8),t);r.position.set(n,.9,0),r.castShadow=!0,e.add(r)}let a=new q(new J(2.15,.2,.24),t);a.position.set(0,1.62,0),a.castShadow=!0,e.add(a);let o=new q(new J(2.55,.16,.32),n);o.position.set(0,1.86,0),o.castShadow=!0,e.add(o);let s=new q(new Bi(.22,.34,12),Q({color:$.beacon}));return s.position.set(0,1.33,0),s.castShadow=!0,e.add(s),Uu(e,.026),e}function Ku(){let e=new G,t=Q({color:15915189}),n=Q({color:$.roofB}),r=Q({color:$.trunk}),i=new q(new zi(.62,.78,1.65,8),t);i.position.y=.86,i.castShadow=i.receiveShadow=!0,e.add(i);let a=new q(new Bi(.86,.72,8),n);a.position.y=2.02,a.castShadow=!0,e.add(a);let o=new q(new zi(.12,.12,.16,10),r);o.position.set(0,1.45,.68),o.rotation.x=Math.PI/2,o.castShadow=!0,e.add(o);for(let t=0;t<4;t++){let n=new q(new J(.13,.78,.08),r);n.position.set(0,1.45,.78),n.rotation.z=Math.PI/2*t+Math.PI/5,n.castShadow=!0,e.add(n)}let s=new q(new co(.82,.025,6,40),Q({color:16773314}));return s.position.set(0,.1,0),s.rotation.x=Math.PI/2,e.add(s),Uu(e,.026),e}function qu(){let e=new G,t=new va,n=[[-.62,-.28],[-.35,-.34],[.05,-.31],[.54,-.25],[.66,-.04],[.55,.24],[.18,.31],[-.3,.29],[-.68,.18],[-.74,-.08]];t.moveTo(n[0][0],n[0][1]);for(let e=1;e<n.length;e++)t.lineTo(n[e][0],n[e][1]);t.closePath();let r=new q(new ao(t),new ii({color:15718314,side:2}));r.rotation.x=-Math.PI/2,r.position.y=.018,r.castShadow=!1,r.receiveShadow=!0,e.add(r);let i=new q(new J(1.18,.018,.035),Q({color:14068597}));i.position.set(.01,.035,-.2),i.rotation.y=-.03,e.add(i);let a=i.clone();a.position.set(-.06,.036,.22),a.scale.x=.72,a.rotation.y=.08,e.add(a);for(let t=0;t<4;t++){let n=new q(new so(.035+t*.006,6,4),Q({color:13149039}));n.position.set(-.42+t*.28,.05,t%2?.16:-.13),n.scale.y=.28,e.add(n)}return e}function Ju(){let e=new G;for(let t=0;t<8;t++){let n=qu(),r=-.9+t*.25;n.position.set(Math.sin(r)*2.2,0,Math.cos(r)*1.25),n.rotation.y=r+Math.PI/2,n.scale.set(1.55,1,1.2),e.add(n)}return e}function Yu(){let e=new G,t=[16766541,16747198,10213375,16777215];for(let n=0;n<8;n++){let r=new q(new zi(.012,.015,.22,5),Q({color:5020501})),i=n/8*Math.PI*2,a=.15+n%3*.09;r.position.set(Math.cos(i)*a,.11,Math.sin(i)*a),e.add(r);let o=new q(new so(.045,6,5),Q({color:t[n%t.length]}));o.position.set(r.position.x,.24,r.position.z),e.add(o)}return e}function Xu(){let e=new G,t=Q({color:9396037}),n=Q({color:7293240}),r=Q({color:16758480}),i=Q({color:16766435}),a=Q({color:16749757}),o=new q(new zi(.24,.34,1.75,8),t);o.position.y=.85,o.rotation.z=-.08,o.castShadow=!0,e.add(o);for(let t=0;t<5;t++){let r=new q(new zi(.06,.1,1.05,7),n);r.position.set((t-2)*.18,1.45+t%2*.12,0),r.rotation.z=-.72+t*.36,r.rotation.x=t%2==0?.32:-.28,r.castShadow=!0,e.add(r)}let s=[[-.55,2,0,.72,r],[.15,2.25,.08,.88,i],[.72,1.96,-.05,.7,r],[-.05,1.82,.44,.62,a],[.1,1.86,-.5,.62,r]];for(let[t,n,r,i,a]of s){let o=new q(new so(i,12,10),a);o.position.set(t,n,r),o.scale.y=.82,o.castShadow=!0,e.add(o)}for(let t=0;t<18;t++){let n=new q(new J(.12,.018,.07),t%3==0?a:i),r=t/18*Math.PI*2,o=.9+t%4*.18;n.position.set(Math.cos(r)*o,.18+t%5*.08,Math.sin(r)*o),n.rotation.set(.15*t,r,.4),e.add(n)}return Uu(e,.028),e}function Zu(){let e=new G,t=Q({color:14241085}),n=Q({color:8203562}),r=Q({color:$.beacon});for(let n of[-.55,.55]){let r=new q(new zi(.08,.1,1.05,8),t);r.position.set(n,.54,0),r.castShadow=!0,e.add(r)}let i=new q(new J(1.55,.16,.22),t);i.position.y=1.1,i.castShadow=!0,e.add(i);let a=new q(new J(1.9,.12,.28),n);a.position.y=1.28,a.castShadow=!0,e.add(a);let o=new q(new J(.26,.32,.08),r);return o.position.set(0,.88,.13),o.castShadow=!0,e.add(o),Uu(e,.024),e}function Qu(){let e=new G,t=Q({color:12234912}),n=Q({color:16767114,emissive:16754779});for(let r of[-.36,.36]){let i=new q(new zi(.045,.06,.55,6),t);i.position.set(r,.28,0),i.castShadow=!0;let a=new q(new J(.22,.24,.22),n);a.position.set(r,.66,0),a.castShadow=!0;let o=new q(new Bi(.18,.16,4),t);o.position.set(r,.86,0),o.rotation.y=Math.PI/4,o.castShadow=!0,e.add(i,a,o)}return Uu(e,.018),e}function $u(e=$.roofA){let t=new G,n=Q({color:$.trunk}),r=Q({color:e}),i=Q({color:16771260}),a=new q(new J(1.25,.42,.55),n);a.position.y=.36,a.castShadow=!0,t.add(a);for(let e of[-.5,.5]){let r=new q(new zi(.035,.045,1.15,6),n);r.position.set(e,.92,-.18),r.castShadow=!0,t.add(r)}let o=new q(new J(1.5,.14,.75),r);o.position.set(0,1.48,-.05),o.rotation.x=-.08,o.castShadow=!0,t.add(o);for(let e=0;e<4;e++){let n=new q(new J(.22,.16,.78),e%2==0?i:r);n.position.set(-.48+e*.32,1.49,-.05),n.rotation.x=-.08,n.castShadow=!0,t.add(n)}let s=[16739164,16766044,8114282,7649279];for(let e=0;e<8;e++){let n=new q(new so(.08,8,6),Q({color:s[e%s.length]}));n.position.set(-.45+e%4*.3,.68,.2-Math.floor(e/4)*.18),n.castShadow=!0,t.add(n)}return Uu(t,.022),t}function ed(){let e=new G,t=Q({color:12038565}),n=Q({color:7653337,transparent:!0,opacity:.86,emissive:3845840}),r=new q(new zi(.98,1.08,.28,18),t);r.position.y=.14,r.receiveShadow=!0,r.castShadow=!0,e.add(r);let i=new q(new zi(.72,.9,.22,18),n);i.position.y=.35,e.add(i);let a=new q(new zi(.12,.18,.78,12),t);a.position.y=.78,a.castShadow=!0,e.add(a);let o=new q(new so(.24,12,8),n);return o.position.y=1.24,o.scale.y=1.4,e.add(o),Uu(e,.018),e}function td(e=$.beacon){let t=new G,n=Q({color:$.trunk}),r=Q({color:e}),i=new q(new zi(.055,.07,1.18,7),n);i.position.y=.59,i.castShadow=!0,t.add(i);let a=new q(new J(.8,.24,.08),r);a.position.set(.28,1.05,0),a.castShadow=!0,t.add(a);let o=new q(new Bi(.16,.28,3),r);return o.position.set(.78,1.05,0),o.rotation.z=-Math.PI/2,o.castShadow=!0,t.add(o),Uu(t,.018),t}function nd(){let e=new G,t=Q({color:$.houseWall}),n=Q({color:14276552}),r=Q({color:14184276}),i=Q({color:2043703}),a=Q({color:$.beacon}),o=new q(new J(2.7,1.55,1.7),t);o.position.y=.82,o.castShadow=o.receiveShadow=!0,e.add(o);let s=new q(new J(2.2,.18,.95),n);s.position.set(0,.18,1.05),s.castShadow=s.receiveShadow=!0,e.add(s);let c=new q(new Bi(2.18,1,4),r);c.position.y=1.9,c.rotation.y=Math.PI/4,c.scale.z=.72,c.castShadow=!0,e.add(c);for(let t of[-.88,.88]){let r=new q(new zi(.08,.1,.9,7),n);r.position.set(t,.66,1.18),r.castShadow=!0,e.add(r)}let l=new q(new J(.55,.85,.08),i);l.position.set(0,.62,.9),e.add(l);for(let t of[-.78,.78]){let n=new q(new J(.45,.42,.07),Q({color:12445923,emissive:5945522}));n.position.set(t,.92,.91),e.add(n)}let u=new q(new J(1.28,.32,.1),a);u.position.set(0,1.45,.93),u.castShadow=!0,e.add(u);let d=new q(new J(.62,.26,.08),t);d.position.set(0,1.45,1),e.add(d);let f=new q(new zi(.035,.04,1.55,6),i);f.position.set(1.52,1.25,.3),e.add(f);let p=new q(new J(.55,.32,.05),r);return p.position.set(1.82,1.86,.3),e.add(p),Uu(e,.026),e}function rd(){let e=new G,t=[Q({color:$.houseWall}),Q({color:$.houseWallAlt}),Q({color:15196104})],n=[Q({color:$.roofA}),Q({color:$.roofB}),Q({color:14200907})];for(let r=0;r<4;r++){let i=-1.8+r*1.18,a=.95+r%2*.25,o=new q(new J(.95,a,1.05),t[r%t.length]);o.position.set(i,a/2,0),o.castShadow=o.receiveShadow=!0,e.add(o);let s=new q(new Bi(.76,.55,4),n[r%n.length]);s.position.set(i,a+.32,0),s.rotation.y=Math.PI/4,s.scale.z=.78,s.castShadow=!0,e.add(s);let c=new q(new J(.22,.48,.06),Q({color:$.door}));c.position.set(i-.18,.28,.56),e.add(c);let l=new q(new J(.24,.22,.055),Q({color:12445923,emissive:4893101}));l.position.set(i+.2,a*.62,.56),e.add(l)}let r=Q({color:3116120});for(let t of[-2.45,2]){let n=new q(new so(.45,8,6),r);n.position.set(t,.32,.55),n.scale.set(1.2,.65,.55),n.castShadow=!0,e.add(n)}return Uu(e,.022),e}function id(){let e=new G,t=Wu();t.scale.setScalar(1.2),t.position.set(0,0,.6),e.add(t);for(let t=0;t<3;t++){let n=new q(new J(.36,.36,.36),Q({color:t%2?14200907:12158293}));n.position.set(-1+t*.45,.23,-.35+t%2*.22),n.castShadow=!0,e.add(n)}let n=new q(new J(1.35,.32,.55),Q({color:7049158}));return n.position.set(1.4,.36,1.25),n.rotation.z=.08,n.castShadow=!0,e.add(n),Uu(e,.018),e}function ad(){let e=new G,t=[15921120,15196104,14276552,16048065],n=[$.roofA,$.roofB,$.roofC,14200907];for(let r=0;r<5;r++){let i=-2.4+r*1.18,a=.95+r%2*.16,o=1.15+r%3*.22,s=r%2*.18,c=new q(new J(a,o,.88),Q({color:t[r%t.length]}));c.position.set(i,o/2,s),c.rotation.z=(r-2)*.015,c.castShadow=c.receiveShadow=!0,e.add(c);let l=new q(new J(a+.28,.22,1.08),Q({color:n[r%n.length]}));l.position.set(i,o+.18,s),l.rotation.z=.08*(r%2?-1:1),l.rotation.x=.1*(r%2?1:-1),l.castShadow=!0,e.add(l);let u=new q(new J(a*.82,.38,.08),Q({color:3232858}));u.position.set(i,.55,s+.48),e.add(u);let d=new q(new J(a*.72,.18,.09),Q({color:r%2?$.beacon:10213375}));d.position.set(i,1,s+.5),e.add(d);for(let t of[-.22,.22]){let n=new q(new J(.22,.24,.075),Q({color:12445923,emissive:4893101}));n.position.set(i+t,o*.72,s+.49),e.add(n)}}return Uu(e,.022),e}function od(){let e=new G,t=Q({color:16771003}),n=Q({color:$.trunk});for(let t of[-1.4,1.4]){let r=new q(new zi(.05,.07,1.35,6),n);r.position.set(t,.68,0),r.castShadow=!0,e.add(r)}let r=new q(new J(2.82,.035,.035),t);r.position.y=1.25,e.add(r);let i=[$.roofA,16771003,$.roofB,$.roofC,10213375];for(let t=0;t<i.length;t++){let n=new q(new J(.34,.38,.035),Q({color:i[t]}));n.position.set(-.92+t*.46,.98-t%2*.04,0),n.rotation.z=t%2?-.05:.06,e.add(n)}return Uu(e,.014),e}function sd(){let e=new G,t=new q(new J(4.6,.05,1.15),new ii({color:4893101}));t.position.y=.03,e.add(t);let n=new q(new J(1.35,.18,1.6),Q({color:12158293}));n.position.y=.18,n.rotation.y=Math.PI/2,n.castShadow=!0,e.add(n);for(let t of[-.58,.58]){let n=new q(new J(.08,.5,1.72),Q({color:16771003}));n.position.set(t,.48,0),e.add(n)}return Uu(e,.018),e}var cd=new Set([`KeyW`,`KeyA`,`KeyS`,`KeyD`,`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`]),ld=class{down=new Set;onDown=e=>{cd.has(e.code)&&e.preventDefault(),this.down.add(e.code)};onUp=e=>{this.down.delete(e.code)};constructor(){window.addEventListener(`keydown`,this.onDown),window.addEventListener(`keyup`,this.onUp)}get move(){return(this.down.has(`KeyW`)||this.down.has(`ArrowUp`)?1:0)-(this.down.has(`KeyS`)||this.down.has(`ArrowDown`)?1:0)}get turn(){return(this.down.has(`KeyD`)||this.down.has(`ArrowRight`)?1:0)-(this.down.has(`KeyA`)||this.down.has(`ArrowLeft`)?1:0)}dispose(){window.removeEventListener(`keydown`,this.onDown),window.removeEventListener(`keyup`,this.onUp)}};function ud(e,t){return t[Math.floor(e()*t.length)]}function dd(e){let t=new G,n=.7+e()*.4,r=new q(new zi(.15,.22,n,7),Q({color:$.trunk}));r.position.y=n/2,r.castShadow=!0,t.add(r);let i=2+Math.floor(e()*2),a=n-.1,o=.95+e()*.35;for(let e=0;e<i;e++){let n=.95,r=new q(new Bi(o,n,8),Q({color:e%2==0?$.leaf:$.leafAlt}));r.position.y=a+n*.4,r.castShadow=!0,t.add(r),a+=n*.45,o*=.72}return Uu(t,.03),t}function fd(e){let t=new G,n=.6+e()*.4,r=new q(new zi(.14,.2,n,7),Q({color:$.trunk}));r.position.y=n/2,r.castShadow=!0,t.add(r);let i=2+Math.floor(e()*2);for(let r=0;r<i;r++){let i=new q(new so(.55+e()*.3,9,8),Q({color:e()>.5?$.leaf:$.leafAlt}));i.position.set((e()-.5)*.5,n+.3+r*.28,(e()-.5)*.5),i.scale.y=.9,i.castShadow=!0,t.add(i)}return Uu(t,.03),t}function pd(e){let t=new G,n=1.1+e()*.5,r=1+e()*.4,i=.85+e()*.35,a=new q(new J(n,i,r),Q({color:e()>.5?$.houseWall:$.houseWallAlt}));a.position.y=i/2,a.castShadow=!0,a.receiveShadow=!0,t.add(a);let o=new q(new Bi(Math.max(n,r)*.9,.72,4),Q({color:ud(e,[$.roofA,$.roofB,$.roofC])}));o.position.y=i+.34,o.rotation.y=Math.PI/4+(e()-.5)*.08,o.scale.z=.75+e()*.18,o.castShadow=!0,t.add(o);let s=new q(new J(.68,.12,.32),Q({color:14205852}));s.position.set(0,.08,r/2+.16),s.castShadow=s.receiveShadow=!0,t.add(s);let c=new q(new J(.3,.5,.06),Q({color:$.door}));c.position.set(-.18,.25,r/2+.035),t.add(c);let l=Q({color:12445923,emissive:4893101});for(let[n,a]of[[.24,.46],[-.35,i*.72],[.35,i*.78]]){let i=new q(new J(.22,.22,.055),l);i.position.set(n,a,r/2+.04),t.add(i);let o=new q(new J(.34,.07,.11),Q({color:ud(e,[$.roofA,$.roofB,$.beacon])}));o.position.set(n,a+.17,r/2+.09),o.rotation.x=-.16,t.add(o)}let u=new q(new J(.42,.22,.06),Q({color:$.beacon}));u.position.set(n/2+.035,.78,.16),u.rotation.y=Math.PI/2,t.add(u);let d=new q(new J(.18,.45,.18),Q({color:12166539}));d.position.set(n*.28,i+.48,r*.08),d.castShadow=!0,t.add(d);let f=Q({color:9396037}),p=Q({color:$.leafAlt});for(let e of[-n*.34,n*.34]){let n=new q(new J(.34,.12,.12),f);n.position.set(e,.25,r/2+.1),t.add(n);let i=new q(new so(.13,7,5),p);i.position.set(e,.36,r/2+.1),i.scale.set(1.4,.6,.6),t.add(i)}return Uu(t,.03),t}function md(e){let t=new G,n=.3+e()*.35,r=new q(new no(n,0),Q({color:9079456}));return r.position.y=n*.55,r.scale.set(1,.7+e()*.3,1),r.rotation.set(e()*3,e()*3,e()*3),r.castShadow=!0,r.receiveShadow=!0,t.add(r),Uu(t,.025),t}function hd(e){let t=new G,n=2+Math.floor(e()*2);for(let r=0;r<n;r++){let n=.32+e()*.18,r=new q(new so(n,8,7),Q({color:e()>.5?$.leafAlt:$.leaf}));r.position.set((e()-.5)*.5,n*.7,(e()-.5)*.5),r.scale.y=.8,r.castShadow=!0,t.add(r)}return Uu(t,.025),t}function gd(e=$.roofA,t=16773314){let n=new G,r=new q(new J(.5,.5,.5),Q({color:e}));r.castShadow=!0,n.add(r);let i=Q({color:t}),a=new q(new J(.54,.1,.54),i),o=new q(new J(.1,.54,.54),i);return n.add(a,o),Uu(n,.02),n}function _d(e=$.roofB){let t=new G,n=new q(new zi(.07,.07,.9,6),Q({color:$.trunk}));n.position.y=.45,n.castShadow=!0,t.add(n);let r=new q(new J(.4,.3,.55),Q({color:e}));r.position.y=1,r.castShadow=!0,t.add(r);let i=new q(new J(.04,.18,.14),Q({color:$.beacon}));return i.position.set(.22,1.05,0),t.add(i),Uu(t,.022),t}function vd(e,t,n){let r=new q(new io(e,t,40),new ii({color:n,transparent:!0,opacity:.55,side:2,depthWrite:!1}));return r.rotation.x=-Math.PI/2,r.renderOrder=2,r}function yd(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()}function bd(e){let t=`700 48px Quicksand, "Trebuchet MS", system-ui, sans-serif`,n=document.createElement(`canvas`),r=n.getContext(`2d`);r.font=t;let i=r.measureText(e).width;n.width=Math.ceil(i+60),n.height=88,r.font=t,r.textAlign=`center`,r.textBaseline=`middle`,yd(r,2,2,n.width-4,n.height-4,26),r.fillStyle=`rgba(38, 31, 58, 0.82)`,r.fill(),r.lineWidth=4,r.strokeStyle=`rgba(255, 213, 150, 0.5)`,r.stroke(),r.fillStyle=`#ffffff`,r.fillText(e,n.width/2,n.height/2+3);let a=new Fi(n);a.colorSpace=Re,a.anisotropy=4;let o=new Jr(new Pr({map:a,transparent:!0,depthWrite:!1})),s=.85;return o.scale.set(s*(n.width/n.height),s,1),o}var xd=new H(0,1,0),Sd=new kt;function Cd(e){let t=e>>>0;return()=>{t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function wd(e,t){let n=(90-e)*Ot.DEG2RAD,r=t*Ot.DEG2RAD;return new H(Math.sin(n)*Math.cos(r),Math.cos(n),Math.sin(n)*Math.sin(r))}function Td(e){let t=e()*2-1,n=e()*Math.PI*2,r=Math.sqrt(Math.max(0,1-t*t));return new H(r*Math.cos(n),t,r*Math.sin(n))}function Ed(e,t,n,r=0){e.position.copy(t).multiplyScalar(n),e.quaternion.setFromUnitVectors(xd,t),r!==0&&(Sd.setFromAxisAngle(t,r),e.quaternion.premultiply(Sd))}var Dd=null,Od=1;function kd(){if(Dd)return Dd;let e=Cd(24301);Dd=[],Od=0;for(let t=0;t<6;t++){let n=1/(t+1);Dd.push({dir:Td(e),freq:1.1+t*1.35,phase:e()*Math.PI*2,amp:n}),Od+=n}return Dd}function Ad(e){let t=0;for(let n of kd())t+=n.amp*Math.sin(e.dot(n.dir)*n.freq+n.phase);return t/Od}var jd=-.55;function Md(e){return Ad(e)>-.5}var Nd=new K(4893101),Pd=new K(6472637),Fd=new K(5218919),Id=new K(5218919),Ld=new K(3116120),Rd=new K(7649148);function zd(e,t){let n=Ad(e);if(n<jd){let e=Ot.clamp((jd-n)/.5,0,1);return t.copy(Pd).lerp(Nd,e)}if(n<-.5)return t.copy(Fd);if(n<.35){let e=Ot.clamp((n-jd)/.4,0,1);return t.copy(Ld).lerp(Id,e)}let r=Ot.clamp((n-.35)/.4,0,1);return t.copy(Id).lerp(Rd,r)}var Bd=class{group=new G;radius=Z.planetRadius;mesh;constructor(){let e=new no(this.radius,24),t=e.getAttribute(`position`),n=new Float32Array(t.count*3),r=new Float32Array(t.count*3),i=new H,a=new K;for(let e=0;e<t.count;e++)i.set(t.getX(e),t.getY(e),t.getZ(e)).normalize(),r[e*3]=i.x,r[e*3+1]=i.y,r[e*3+2]=i.z,zd(i,a),n[e*3]=a.r,n[e*3+1]=a.g,n[e*3+2]=a.b;e.setAttribute(`normal`,new gr(r,3)),e.setAttribute(`color`,new gr(n,3)),this.mesh=new q(e,Q({vertexColors:!0})),this.mesh.receiveShadow=!0,this.group.add(this.mesh)}surfacePoint(e,t=new H){return t.copy(e).multiplyScalar(this.radius)}scatter(e,t=[],n=150){let r=[{make:dd,weight:4},{make:fd,weight:3},{make:hd,weight:3},{make:md,weight:2},{make:pd,weight:1}],i=r.reduce((e,t)=>e+t.weight,0),a=new H,o=0,s=0;for(;o<n&&s<n*12;){if(s++,a.copy(Td(e)),!Md(a))continue;let n=!1;for(let e of t)if(a.angleTo(e)<.13){n=!0;break}if(n)continue;let c=e()*i,l=r[0].make;for(let e of r){if(c<e.weight){l=e.make;break}c-=e.weight}let u=l(e);Ed(u,a,this.radius,e()*Math.PI*2),this.group.add(u),o++}}},Vd=class{group=new G;model=new G;up=new H(0,1,0);forward=new H(0,0,1);right=new H(1,0,0);position=new H;radius=Z.planetRadius;basis=new Zt;q=new kt;axis=new H;bobPhase=0;constructor(e){this.buildModel(),this.group.add(this.model),this.reset(e)}reset(e){this.up.copy(e).normalize(),this.forward.set(0,1,0),Math.abs(this.up.dot(this.forward))>.9&&this.forward.set(1,0,0),this.forward.addScaledVector(this.up,-this.forward.dot(this.up)).normalize(),this.bobPhase=0,this.sync(0,0)}update(e,t,n){n!==0&&(this.q.setFromAxisAngle(this.up,-n*Z.turnSpeed*e),this.forward.applyQuaternion(this.q));let r=0;if(t!==0){let n=t*Z.walkSpeed*e/this.radius;this.axis.copy(this.up).cross(this.forward).normalize(),this.q.setFromAxisAngle(this.axis,n),this.up.applyQuaternion(this.q),this.forward.applyQuaternion(this.q),r=Math.abs(t)}this.up.normalize(),this.forward.addScaledVector(this.up,-this.forward.dot(this.up)).normalize(),this.sync(e,r)}sync(e,t){this.right.copy(this.up).cross(this.forward).normalize(),this.position.copy(this.up).multiplyScalar(this.radius),this.group.position.copy(this.position),this.basis.makeBasis(this.right,this.up,this.forward),this.group.quaternion.setFromRotationMatrix(this.basis),this.bobPhase+=e*t*14;let n=t>0?Math.abs(Math.sin(this.bobPhase))*.12:0;this.model.position.y=n,this.model.rotation.z=t>0?Math.sin(this.bobPhase)*.05:0}buildModel(){let e=this.model,t=new zi(.12,.12,.45,7);for(let n of[-1,1]){let r=new q(t,Q({color:$.courierHat}));r.position.set(n*.17,.225,0),r.castShadow=!0,e.add(r)}let n=new q(new J(.7,.78,.46),Q({color:$.courierBody}));n.position.y=.84,n.castShadow=!0,e.add(n);let r=new q(new J(.58,.56,.3),Q({color:$.courierBag}));r.position.set(0,.92,-.34),r.castShadow=!0,e.add(r);let i=new q(new J(.12,.9,.5),Q({color:$.courierBag}));i.position.set(.12,.92,0),i.rotation.z=.18,e.add(i);let a=new q(new so(.3,12,10),Q({color:$.courierSkin}));a.position.y=1.46,a.castShadow=!0,e.add(a);let o=new q(new zi(.34,.34,.07,14),Q({color:$.courierHat}));o.position.y=1.66,o.castShadow=!0,e.add(o);let s=new q(new Bi(.27,.34,14),Q({color:$.courierHat}));s.position.y=1.86,s.castShadow=!0,e.add(s);let c=new q(new so(.07,8,6),Q({color:$.courierSkin}));c.position.set(0,1.42,.29),e.add(c),Uu(e,.025)}},Hd=[$.roofA,$.roofB,$.roofC],Ud=class{group=new G;deliveries=[];activeIndex=0;constructor(e,t=Z.planetRadius){e.forEach((e,n)=>{let r=this.build(e.dir,e.name,t,n);this.deliveries.push(r),this.group.add(r.group)}),this.refreshVisibility()}get total(){return this.deliveries.length}get delivered(){return this.deliveries.filter(e=>e.done).length}get complete(){return this.delivered>=this.total}active(){return this.deliveries[this.activeIndex]??null}update(e,t,n){let r=this.active();return!r||r.done?null:(r.parcel.position.y=1.7+Math.sin(n*2)*.18,r.parcel.rotation.y+=t*1.2,r.ring.scale.setScalar(1+Math.sin(n*3)*.06),e.distanceTo(r.position)<=Z.deliverRadius?(r.done=!0,this.activeIndex++,this.refreshVisibility(),r):null)}reset(){this.activeIndex=0;for(let e of this.deliveries)e.done=!1,e.parcel.position.y=1.7,e.parcel.rotation.y=0,e.ring.scale.setScalar(1);this.refreshVisibility()}build(e,t,n,r){let i=new G;Ed(i,e,n);let a=Hd[r%Hd.length],o=_d(a);i.add(o);let s=vd(1.4,2,$.beacon);s.position.y=.02,i.add(s);let c=gd(a);c.position.y=1.7,i.add(c);let l=bd(t);l.position.y=2.7,i.add(l);let u=new q(new zi(.13,.13,8,12,1,!0),new ii({color:$.beacon,transparent:!0,opacity:.16,depthWrite:!1,side:2,blending:2}));return u.position.y=4,i.add(u),{dir:e.clone(),position:e.clone().multiplyScalar(n),name:t,group:i,ring:s,ringMat:s.material,parcel:c,label:l,pillar:u,done:!1}}refreshVisibility(){this.deliveries.forEach((e,t)=>{let n=t===this.activeIndex;e.done?(e.ringMat.color.set($.beaconDone),e.ringMat.opacity=.5):(e.ringMat.color.set($.beacon),e.ringMat.opacity=n?.55:.18),e.parcel.visible=n&&!e.done,e.pillar.visible=n&&!e.done,e.label.visible=n||e.done})}},Wd=`
  varying vec3 vDir;
  void main() {
...
`;function Kd(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.3,`rgba(255,250,230,0.9)`),n.addColorStop(1,`rgba(255,250,230,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Fi(e)}var qd=class{group=new G;sunDirection=new H(.55,.72,.42).normalize();stars;starMaterial;domeMaterial;constructor(e=170){this.domeMaterial=new vo({uniforms:{topColor:{value:new K($.skyZenith)},midColor:{value:new K($.skyMid)},botColor:{value:new K($.skyHorizon)},sunColor:{value:new K($.sunGlow)},sunDir:{value:this.sunDirection}},vertexShader:Wd,fragmentShader:Gd,side:1,depthWrite:!1,fog:!1});let t=new q(new so(e,32,24),this.domeMaterial);t.renderOrder=-1,this.group.add(t);let n=new Float32Array(720*3),r=new Float32Array(720*3),i=Cd(22436),a=new K($.star),o=new K(12571903),s=new K,c=e*.92;for(let e=0;e<720;e++){let t=Td(i);n[e*3]=t.x*c,n[e*3+1]=t.y*c,n[e*3+2]=t.z*c,s.copy(a).lerp(o,i()*.6),r[e*3]=s.r,r[e*3+1]=s.g,r[e*3+2]=s.b}let l=new Or;l.setAttribute(`position`,new gr(n,3)),l.setAttribute(`color`,new gr(r,3)),this.starMaterial=new Di({size:2.2,map:Kd(),vertexColors:!0,transparent:!0,depthWrite:!1,sizeAttenuation:!1,blending:2}),this.stars=new Mi(l,this.starMaterial),this.stars.renderOrder=-1,this.group.add(this.stars)}update(e,t){this.stars.rotation.y+=e*.006,this.starMaterial.opacity=.65+.3*Math.sin(t*.7)}},Jd=`An original prototype — every shape, colour, and line of code is generated from primitives in this repository. No third-party game assets, source, or layouts are used or copied. Not affiliated with any existing game.`;function Yd(e,t={}){let n=document.createElement(e);return t.className&&(n.className=t.className),t.id&&(n.id=t.id),t.html!==void 0&&(n.innerHTML=t.html),n}var Xd=class{onStart=()=>{};onReplay=()=>{};overlay;card;hud;objectiveText;objectiveHint;countDone;countTotal;compass;needle;dist;toast;touch;fwd=!1;back=!1;left=!1;right=!1;toastTimer=0;constructor(e){this.card=Yd(`div`,{className:`card`}),this.overlay=Yd(`div`,{className:`overlay`,id:`overlay`}),this.overlay.appendChild(this.card),this.hud=Yd(`div`,{id:`hud`}),this.hud.appendChild(Yd(`div`,{className:`hud-panel`,id:`hud-objective`,html:`<div class="label-tiny">Objective</div><div id="objective-text">Getting ready…</div><div id="objective-hint"></div>`})),this.hud.appendChild(Yd(`div`,{className:`hud-panel`,id:`hud-count`,html:`<div class="label-tiny">Delivered</div><div id="count-value"><span id="count-done">0</span><span class="total" id="count-total">/3</span></div>`})),this.compass=Yd(`div`,{id:`compass`,html:`<div class="ring"></div><div class="needle" id="needle"></div><div class="dist" id="dist">--</div>`}),this.toast=Yd(`div`,{id:`toast`}),this.touch=Yd(`div`,{id:`touch`,html:`<button class="touch-btn" id="t-fwd" aria-label="forward">▲</button><button class="touch-btn" id="t-back" aria-label="back">▼</button><button class="touch-btn" id="t-left" aria-label="left">◀</button><button class="touch-btn" id="t-right" aria-label="right">▶</button>`});let t=Yd(`div`,{className:`hint`,html:`WASD / arrow keys to move • reach the glowing mailbox to deliver`});e.append(this.overlay,this.hud,this.compass,this.toast,this.touch,t),this.objectiveText=this.req(`objective-text`),this.objectiveHint=this.req(`objective-hint`),this.countDone=this.req(`count-done`),this.countTotal=this.req(`count-total`),this.needle=this.req(`needle`),this.dist=this.req(`dist`),this.bindTouch(),window.matchMedia(`(pointer: coarse)`).matches&&document.body.classList.add(`touch`)}get touchMove(){return!!this.fwd-+!!this.back}get touchTurn(){return!!this.right-+!!this.left}get overlayVisible(){return!this.overlay.classList.contains(`hidden`)}showStart(){this.card.innerHTML=`<div class="art-preview poster"><img src="./concept-art-v2.png" alt="Courier town art direction concept" /></div><h1>Courier Town</h1><div class="subtitle">A compact hand-painted delivery neighborhood</div><p>Deliver parcels through a dense little town of markets, post roads, harbor lanes, trees, and glowing mailboxes.</p><div class="controls"><span class="key"><kbd>W</kbd><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd> / arrows — walk &amp; turn</span><span class="key"><kbd>Enter</kbd> — start</span></div><button class="btn" id="start-btn">Start delivering</button><p class="fine-print">${Jd}</p>`,this.overlay.classList.remove(`hidden`),this.card.querySelector(`#start-btn`)?.addEventListener(`click`,()=>this.onStart())}showComplete(e,t){this.card.innerHTML=`<h1>All delivered! 🎉</h1><div class="subtitle">Tiny Planet Messenger</div><p>You delivered all ${e} parcels in <strong>${t}</strong>. The little world thanks you.</p><button class="btn" id="replay-btn">Play again</button>`,this.overlay.classList.remove(`hidden`),this.card.querySelector(`#replay-btn`)?.addEventListener(`click`,()=>this.onReplay())}hideOverlay(){this.overlay.classList.add(`hidden`)}showHud(e){this.hud.classList.toggle(`show`,e)}showCompass(e){this.compass.classList.toggle(`show`,e)}activateTouch(){this.touch.classList.add(`active`)}setObjective(e,t){this.objectiveText.textContent=e,this.objectiveHint.textContent=t}setCount(e,t){this.countDone.textContent=String(e),this.countTotal.textContent=`/${t}`}updateCompass(e,t){this.needle.style.transform=`translate(-50%, -100%) rotate(${e}deg)`,this.dist.textContent=`${Math.round(t)}m`}showToast(e){this.toast.textContent=e,this.toast.classList.add(`show`),window.clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>{this.toast.classList.remove(`show`)},1600)}req(e){let t=document.getElementById(e);if(!t)throw Error(`UI element #${e} missing`);return t}bindTouch(){let e=(e,t)=>{let n=this.req(e),r=e=>{e.preventDefault(),t(!0)},i=()=>t(!1);n.addEventListener(`pointerdown`,r),n.addEventListener(`pointerup`,i),n.addEventListener(`pointerleave`,i),n.addEventListener(`pointercancel`,i)};e(`t-fwd`,e=>this.fwd=e),e(`t-back`,e=>this.back=e),e(`t-left`,e=>this.left=e),e(`t-right`,e=>this.right=e)}},Zd=-10,Qd=104;function $d(e,t){return wd(Zd+t/Z.planetRadius*Ot.RAD2DEG,Qd+e/(Z.planetRadius*Math.cos(Zd*Ot.DEG2RAD))*Ot.RAD2DEG)}var ef=$d(0,-24),tf=[{name:`Harbor Post`,dir:$d(30,-34)},{name:`Hill Shrine`,dir:$d(-42,26)},{name:`Forest Mill`,dir:$d(48,34)}];function nf(e){return Math.max(-1,Math.min(1,e))}function rf(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}var af=class{renderer;scene=new Pn;camera=new Qo(48,1,.1,500);clock=new vs;keyboard=new ld;ui;sky=new qd;planet=new Bd;player=new Vd(ef);quests=new Ud(tf);tmp=new H;tmp2=new H;camTarget=new H;lookTarget=new H;running=!1;playing=!1;elapsed=0;playStartedAt=0;root;constructor(e){this.root=e,this.renderer=new Iu({antialias:!0,alpha:!1}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.outputColorSpace=Re,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.08,this.renderer.setClearColor($.skyZenith,1),this.scene.background=new K($.skyZenith),this.scene.fog=new Nn($.skyZenith,.0055),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.root.appendChild(this.renderer.domElement),this.ui=new Xd(e),this.ui.onStart=()=>this.beginRun(),this.ui.onReplay=()=>this.beginRun(),this.buildScene(),this.bindEvents(),this.resize(),this.updateHud(),this.ui.showStart()}start(){this.running||(this.running=!0,this.clock.start(),this.renderer.setAnimationLoop(()=>this.frame()))}dispose(){this.running=!1,this.renderer.setAnimationLoop(null),this.keyboard.dispose(),window.removeEventListener(`resize`,this.resize),this.renderer.dispose()}buildScene(){this.scene.add(this.sky.group);let e=new Bo($.hemiSky,$.hemiGround,2.1);this.scene.add(e);let t=new ts($.sunLight,4.2);t.position.copy(this.sky.sunDirection).multiplyScalar(60),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.near=5,t.shadow.camera.far=140,t.shadow.camera.left=-28,t.shadow.camera.right=28,t.shadow.camera.top=28,t.shadow.camera.bottom=-28,this.scene.add(t),this.scene.add(this.planet.group),this.scene.add(this.quests.group),this.scene.add(this.player.group),this.planet.scatter(Cd(11256099),[ef,...tf.map(e=>e.dir)],28),this.placeNeighborhoodDistrict(),this.placeAuthoredDetails(),this.placeCamera(1)}placeNeighborhoodDistrict(){let e=Cd(29097);for(let e=-54;e<=52;e+=4.2){let t=qu();t.scale.set(7,1,3.2),Ed(t,$d(0,e),Z.planetRadius+.04,.05),this.scene.add(t)}for(let e of[-42,-24,-8,10,28,44])for(let t=-58;t<=58;t+=4.2){let n=qu();n.scale.set(6.4,1,3),Ed(n,$d(t,e),Z.planetRadius+.045,Math.PI/2),this.scene.add(n)}for(let t of[{north:-48,easts:[-48,-36,-22,20,34,48],spin:.2},{north:-32,easts:[-54,-40,-26,18,32,50],spin:-.25},{north:-16,easts:[-46,-30,-16,16,30,46],spin:.35},{north:4,easts:[-54,-38,-20,20,38,54],spin:-.3},{north:22,easts:[-46,-30,-14,14,30,46],spin:.15},{north:40,easts:[-38,-22,22,38],spin:-.15}])for(let n of t.easts){let r=pd(e);r.scale.setScalar(2.4+e()*.8),Ed(r,$d(n,t.north),Z.planetRadius+.055,t.spin+(e()-.5)*.7),this.scene.add(r)}for(let e=0;e<18;e++){let t=e/18*Math.PI*2,n=Yu();n.scale.setScalar(1.8),Ed(n,$d(Math.cos(t)*12,-10+Math.sin(t)*8),Z.planetRadius+.055,t),this.scene.add(n)}for(let[e,t,n]of[[-12,-24,.2],[12,-24,-.35],[-14,-8,.45],[14,-8,-.25],[-16,10,.2],[16,10,-.2]]){let r=Qu();r.scale.setScalar(1.35),Ed(r,$d(e,t),Z.planetRadius+.06,n),this.scene.add(r)}let t=ed();t.scale.setScalar(2.15),Ed(t,$d(0,-8),Z.planetRadius+.07,0),this.scene.add(t);let n=nd();n.scale.setScalar(2.25),Ed(n,$d(-18,-40),Z.planetRadius+.08,.18),this.scene.add(n);for(let[e,t,n]of[[-36,-34,.08],[36,-34,-.1],[-44,-4,Math.PI/2],[44,4,-Math.PI/2],[-34,30,.18],[34,32,-.18]]){let r=rd();r.scale.setScalar(2.05),Ed(r,$d(e,t),Z.planetRadius+.075,n),this.scene.add(r)}let r=id();r.scale.setScalar(2.3),Ed(r,$d(32,-44),Z.planetRadius+.075,-.3),this.scene.add(r);let i=[$.roofA,$.roofB,$.roofC,15905357];for(let[e,t,n,r]of[[0,-18,-14,.55],[1,-8,-2,-.3],[2,10,-2,.2],[3,20,-14,-.55],[1,-20,14,.35],[2,22,14,-.35]]){let a=$u(i[e]);a.scale.setScalar(1.9),Ed(a,$d(t,n),Z.planetRadius+.065,r),this.scene.add(a)}for(let[e,t,n]of[[-6,-42,.1],[8,-42,-.1],[-56,-8,Math.PI/2],[56,10,-Math.PI/2],[-28,44,.4],[30,44,-.4]]){let r=td();r.scale.setScalar(1.55),Ed(r,$d(e,t),Z.planetRadius+.07,n),this.scene.add(r)}for(let[e,t,n,r]of[[-26,-27,.08,2.05],[26,-27,-.08,2.05],[-30,6,Math.PI/2,1.9],[30,8,-Math.PI/2,1.9],[-22,33,.18,1.8],[22,34,-.18,1.8]]){let i=ad();i.scale.setScalar(r),Ed(i,$d(e,t),Z.planetRadius+.08,n),this.scene.add(i)}for(let[e,t,n]of[[-48,-21,Math.PI/2],[48,-18,-Math.PI/2],[-38,18,.35],[38,20,-.35]]){let r=od();r.scale.setScalar(1.7),Ed(r,$d(e,t),Z.planetRadius+.08,n),this.scene.add(r)}for(let[e,t,n,r]of[[0,22,.06,3.2],[-40,-44,.4,2.4],[42,28,-.6,2.2]]){let i=sd();i.scale.setScalar(r),Ed(i,$d(e,t),Z.planetRadius+.055,n),this.scene.add(i)}for(let[e,t,n]of[[-18,-32,-.7],[18,-30,.65],[-22,2,.95],[22,4,-.95],[0,36,.1]]){let r=Ju();r.scale.setScalar(2.15),Ed(r,$d(e,t),Z.planetRadius+.05,n),this.scene.add(r)}}placeAuthoredDetails(){let e=[{dir:tf[0].dir,make:Wu,spin:-.35,scale:2.2},{dir:tf[1].dir,make:Gu,spin:.55,scale:2},{dir:tf[2].dir,make:Ku,spin:.1,scale:1.9}];for(let t of e){let e=t.make();e.scale.setScalar(t.scale),Ed(e,t.dir,Z.planetRadius+.025,t.spin),this.scene.add(e)}let t=Xu();t.scale.setScalar(2.45),Ed(t,$d(16,-4),Z.planetRadius+.03,-.9),this.scene.add(t);let n=Zu();n.scale.setScalar(1.65),Ed(n,$d(-34,20),Z.planetRadius+.045,.35),this.scene.add(n);let r=Zu();r.scale.setScalar(1.32),Ed(r,$d(-44,28),Z.planetRadius+.045,.5),this.scene.add(r);for(let e=0;e<12;e++){let t=e/11,n=ef.clone().lerp(tf[0].dir,t).normalize(),r=qu();if(r.scale.setScalar(2.4+t*.55),Ed(r,n,Z.planetRadius+.035,-.4+t*1.1),this.scene.add(r),e%3==1){let e=Qu();e.scale.setScalar(1.25),Ed(e,n,Z.planetRadius+.055,-.4+t*1.1),this.scene.add(e)}}let i=[$d(-24,-18),$d(-8,-18),$d(8,-18),$d(24,-18),$d(-28,18),$d(28,18)];for(let e of i){let t=Yu();t.scale.setScalar(1.35),Ed(t,e,Z.planetRadius+.04,Math.random()*Math.PI),this.scene.add(t)}}bindEvents(){window.addEventListener(`resize`,this.resize),window.addEventListener(`keydown`,e=>{e.code===`Enter`&&this.ui.overlayVisible&&(e.preventDefault(),this.beginRun())})}resize=()=>{let e=Math.max(1,this.root.clientWidth||window.innerWidth),t=Math.max(1,this.root.clientHeight||window.innerHeight);this.camera.aspect=e/t,this.camera.fov=e<700?58:48,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1)};beginRun(){this.player.reset(ef),this.quests.reset(),this.elapsed=0,this.playStartedAt=this.clock.elapsedTime,this.playing=!0,this.ui.hideOverlay(),this.ui.showHud(!0),this.ui.showCompass(!0),this.ui.activateTouch(),this.ui.showToast(`First parcel loaded — follow the glow!`),this.updateHud(),this.placeCamera(1)}frame(){let e=Math.min(this.clock.getDelta(),.04);if(this.elapsed=this.clock.elapsedTime,this.sky.update(e,this.elapsed),this.playing){let t=nf(this.keyboard.move+this.ui.touchMove),n=nf(this.keyboard.turn+this.ui.touchTurn);this.player.update(e,t,n);let r=this.quests.update(this.player.position,e,this.elapsed);r&&(this.ui.showToast(`Delivered to ${r.name}!`),this.updateHud(),this.quests.complete&&(this.playing=!1,this.ui.showComplete(this.quests.total,rf(this.clock.elapsedTime-this.playStartedAt)),this.ui.showCompass(!1))),this.updateCompass()}this.placeCamera(e),this.renderer.render(this.scene,this.camera)}placeCamera(e){let t=e>=1?1:1-Math.exp(-Z.camLerp*e);this.camTarget.copy(this.player.position).addScaledVector(this.player.up,Z.camHeight).addScaledVector(this.player.forward,-Z.camDistance),this.camera.position.lerp(this.camTarget,t),this.lookTarget.copy(this.player.position).addScaledVector(this.player.up,1.55).addScaledVector(this.player.forward,Z.camLookAhead),this.camera.up.copy(this.player.up),this.camera.lookAt(this.lookTarget)}updateHud(){let e=this.quests.active();e?this.ui.setObjective(`Deliver parcel to ${e.name}`,`Look for the glowing mailbox beacon.`):this.ui.setObjective(`All routes complete`,`Replay to run the route again.`),this.ui.setCount(this.quests.delivered,this.quests.total)}updateCompass(){let e=this.quests.active();if(!e||(this.tmp.copy(e.dir).addScaledVector(this.player.up,-e.dir.dot(this.player.up)),this.tmp.lengthSq()<1e-6))return;this.tmp.normalize();let t=Ot.clamp(this.tmp.dot(this.player.forward),-1,1),n=this.tmp.dot(this.player.right),r=Ot.radToDeg(Math.atan2(n,t)),i=this.player.up.angleTo(e.dir)*Z.planetRadius;this.tmp2.copy(e.position).sub(this.player.position);let a=Math.min(i,this.tmp2.length());this.ui.updateCompass(r,a)}},of=document.querySelector(`#app`);if(!of)throw Error(`Missing #app mount point`);new af(of).start();