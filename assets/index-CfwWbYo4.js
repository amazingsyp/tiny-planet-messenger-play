...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(e,t,n){let r=new Float32Array(_o),i=new U(0,1,0);return new ea({name:`SphericalGaussianBlur`,defines:{n:_o,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(){return new ea({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function No(){return new ea({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Po(),fragmentShader:`
	...
	`}var Fo=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function El(e,t=.04,n=xl){let r=new ea({uniforms:{thickness:{value:t},outlineColor:{value:new q(n)}},vertexShader:wl,fragmentShader:Tl,side:1}),i=new J(e.geometry,r);return i.castShadow=!1,i.receiveShadow=!1,i.userData.isOutline=!0,i.renderOrder=(e.renderOrder??0)-1,e.add(i),i}function Dl(e,t=.04,n=xl){let r=[];e.traverse(e=>{let t=e;t.isMesh&&!e.userData.isOutline&&r.push(t)});for(let e of r)El(e,t,n)}var $={skyZenith:6472637,skyHorizon:9165011,skyMid:4893101,sunGlow:16773577,sunLight:16774364,hemiSky:14283759,hemiGround:6063197,ambient:5991050,land:5218919,landDark:3116120,highland:7649148,sand:13223858,water:6472637,waterDeep:4893101,trunk:10251074,leaf:6270554,leafAlt:8309099,houseWall:15921120,houseWallAlt:14276552,roofA:13987674,roofB:6981316,roofC:13208245,door:8016438,pathRing:15324840,cloud:16645375,star:16774872,courierBody:4161494,courierBag:13128764,courierSkin:15910810,courierHat:3108751,beacon:16765503,beaconDone:9429896,markerRing:16773288};function Ol(){let e=new K,t=Q({color:12158293}),n=Q({color:15982519}),r=Q({color:$.roofA}),i=new J(new Y(3,.18,1.05),t);i.position.set(0,.12,.15),i.castShadow=i.receiveShadow=!0,e.add(i);for(let t of[-1.25,-.35,.55,1.35]){let n=new J(new Y(.1,.08,1.18),Q({color:13934699}));n.position.set(t,.27,.15),n.castShadow=!0,e.add(n)}for(let n of[-1.35,1.35]){let i=new J(new Ri(.09,.11,.9,7),t);i.position.set(n,.55,-.48),i.castShadow=!0,e.add(i);let a=new J(new Wi(.16,8,6),r);a.position.set(n,1.04,-.48),a.castShadow=!0,e.add(a)}let a=new J(new Y(1.15,.28,.42),Q({color:6200278}));a.position.set(.3,.38,.95),a.rotation.z=.08,a.castShadow=!0,e.add(a);let o=new J(new zi(.38,.9,3),n);return o.position.set(.34,.95,.93),o.rotation.y=Math.PI/6,o.castShadow=!0,e.add(o),Dl(e,.026),e}function kl(){let e=new K,t=Q({color:14241085}),n=Q({color:16771003}),r=Q({color:10920631}),i=new J(new Y(1.9,.18,1.45),r);i.position.y=.12,i.castShadow=i.receiveShadow=!0,e.add(i);for(let n of[-.72,.72]){let r=new J(new Ri(.11,.14,1.6,8),t);r.position.set(n,.9,0),r.castShadow=!0,e.add(r)}let a=new J(new Y(2.15,.2,.24),t);a.position.set(0,1.62,0),a.castShadow=!0,e.add(a);let o=new J(new Y(2.55,.16,.32),n);o.position.set(0,1.86,0),o.castShadow=!0,e.add(o);let s=new J(new zi(.22,.34,12),Q({color:$.beacon}));return s.position.set(0,1.33,0),s.castShadow=!0,e.add(s),Dl(e,.026),e}function Al(){let e=new K,t=Q({color:15915189}),n=Q({color:$.roofB}),r=Q({color:$.trunk}),i=new J(new Ri(.62,.78,1.65,8),t);i.position.y=.86,i.castShadow=i.receiveShadow=!0,e.add(i);let a=new J(new zi(.86,.72,8),n);a.position.y=2.02,a.castShadow=!0,e.add(a);let o=new J(new Ri(.12,.12,.16,10),r);o.position.set(0,1.45,.68),o.rotation.x=Math.PI/2,o.castShadow=!0,e.add(o);for(let t=0;t<4;t++){let n=new J(new Y(.13,.78,.08),r);n.position.set(0,1.45,.78),n.rotation.z=Math.PI/2*t+Math.PI/5,n.castShadow=!0,e.add(n)}let s=new J(new Gi(.82,.025,6,40),Q({color:16773314}));return s.position.set(0,.1,0),s.rotation.x=Math.PI/2,e.add(s),Dl(e,.026),e}function jl(){let e=new K,t=new J(new Y(1.15,.055,.66),Q({color:15774598}));return t.position.y=.055,t.castShadow=!1,t.receiveShadow=!0,e.add(t),Dl(e,.012),e}function Ml(){let e=new K,t=[16766541,16747198,10213375,16777215];for(let n=0;n<8;n++){let r=new J(new Ri(.012,.015,.22,5),Q({color:5020501})),i=n/8*Math.PI*2,a=.15+n%3*.09;r.position.set(Math.cos(i)*a,.11,Math.sin(i)*a),e.add(r);let o=new J(new Wi(.045,6,5),Q({color:t[n%t.length]}));o.position.set(r.position.x,.24,r.position.z),e.add(o)}return e}function Nl(){let e=new K,t=Q({color:9396037}),n=Q({color:7293240}),r=Q({color:16758480}),i=Q({color:16766435}),a=Q({color:16749757}),o=new J(new Ri(.24,.34,1.75,8),t);o.position.y=.85,o.rotation.z=-.08,o.castShadow=!0,e.add(o);for(let t=0;t<5;t++){let r=new J(new Ri(.06,.1,1.05,7),n);r.position.set((t-2)*.18,1.45+t%2*.12,0),r.rotation.z=-.72+t*.36,r.rotation.x=t%2==0?.32:-.28,r.castShadow=!0,e.add(r)}let s=[[-.55,2,0,.72,r],[.15,2.25,.08,.88,i],[.72,1.96,-.05,.7,r],[-.05,1.82,.44,.62,a],[.1,1.86,-.5,.62,r]];for(let[t,n,r,i,a]of s){let o=new J(new Wi(i,12,10),a);o.position.set(t,n,r),o.scale.y=.82,o.castShadow=!0,e.add(o)}for(let t=0;t<18;t++){let n=new J(new Y(.12,.018,.07),t%3==0?a:i),r=t/18*Math.PI*2,o=.9+t%4*.18;n.position.set(Math.cos(r)*o,.18+t%5*.08,Math.sin(r)*o),n.rotation.set(.15*t,r,.4),e.add(n)}return Dl(e,.028),e}function Pl(){let e=new K,t=Q({color:14241085}),n=Q({color:8203562}),r=Q({color:$.beacon});for(let n of[-.55,.55]){let r=new J(new Ri(.08,.1,1.05,8),t);r.position.set(n,.54,0),r.castShadow=!0,e.add(r)}let i=new J(new Y(1.55,.16,.22),t);i.position.y=1.1,i.castShadow=!0,e.add(i);let a=new J(new Y(1.9,.12,.28),n);a.position.y=1.28,a.castShadow=!0,e.add(a);let o=new J(new Y(.26,.32,.08),r);return o.position.set(0,.88,.13),o.castShadow=!0,e.add(o),Dl(e,.024),e}function Fl(){let e=new K,t=Q({color:12234912}),n=Q({color:16767114,emissive:16754779});for(let r of[-.36,.36]){let i=new J(new Ri(.045,.06,.55,6),t);i.position.set(r,.28,0),i.castShadow=!0;let a=new J(new Y(.22,.24,.22),n);a.position.set(r,.66,0),a.castShadow=!0;let o=new J(new zi(.18,.16,4),t);o.position.set(r,.86,0),o.rotation.y=Math.PI/4,o.castShadow=!0,e.add(i,a,o)}return Dl(e,.018),e}function Il(e=$.roofA){let t=new K,n=Q({color:$.trunk}),r=Q({color:e}),i=Q({color:16771260}),a=new J(new Y(1.25,.42,.55),n);a.position.y=.36,a.castShadow=!0,t.add(a);for(let e of[-.5,.5]){let r=new J(new Ri(.035,.045,1.15,6),n);r.position.set(e,.92,-.18),r.castShadow=!0,t.add(r)}let o=new J(new Y(1.5,.14,.75),r);o.position.set(0,1.48,-.05),o.rotation.x=-.08,o.castShadow=!0,t.add(o);for(let e=0;e<4;e++){let n=new J(new Y(.22,.16,.78),e%2==0?i:r);n.position.set(-.48+e*.32,1.49,-.05),n.rotation.x=-.08,n.castShadow=!0,t.add(n)}let s=[16739164,16766044,8114282,7649279];for(let e=0;e<8;e++){let n=new J(new Wi(.08,8,6),Q({color:s[e%s.length]}));n.position.set(-.45+e%4*.3,.68,.2-Math.floor(e/4)*.18),n.castShadow=!0,t.add(n)}return Dl(t,.022),t}function Ll(){let e=new K,t=Q({color:12038565}),n=Q({color:7653337,transparent:!0,opacity:.86,emissive:3845840}),r=new J(new Ri(.98,1.08,.28,18),t);r.position.y=.14,r.receiveShadow=!0,r.castShadow=!0,e.add(r);let i=new J(new Ri(.72,.9,.22,18),n);i.position.y=.35,e.add(i);let a=new J(new Ri(.12,.18,.78,12),t);a.position.y=.78,a.castShadow=!0,e.add(a);let o=new J(new Wi(.24,12,8),n);return o.position.y=1.24,o.scale.y=1.4,e.add(o),Dl(e,.018),e}function Rl(e=$.beacon){let t=new K,n=Q({color:$.trunk}),r=Q({color:e}),i=new J(new Ri(.055,.07,1.18,7),n);i.position.y=.59,i.castShadow=!0,t.add(i);let a=new J(new Y(.8,.24,.08),r);a.position.set(.28,1.05,0),a.castShadow=!0,t.add(a);let o=new J(new zi(.16,.28,3),r);return o.position.set(.78,1.05,0),o.rotation.z=-Math.PI/2,o.castShadow=!0,t.add(o),Dl(t,.018),t}function zl(){let e=new K,t=Q({color:$.houseWall}),n=Q({color:14276552}),r=Q({color:14184276}),i=Q({color:2043703}),a=Q({color:$.beacon}),o=new J(new Y(2.7,1.55,1.7),t);o.position.y=.82,o.castShadow=o.receiveShadow=!0,e.add(o);let s=new J(new Y(2.2,.18,.95),n);s.position.set(0,.18,1.05),s.castShadow=s.receiveShadow=!0,e.add(s);let c=new J(new zi(2.18,1,4),r);c.position.y=1.9,c.rotation.y=Math.PI/4,c.scale.z=.72,c.castShadow=!0,e.add(c);for(let t of[-.88,.88]){let r=new J(new Ri(.08,.1,.9,7),n);r.position.set(t,.66,1.18),r.castShadow=!0,e.add(r)}let l=new J(new Y(.55,.85,.08),i);l.position.set(0,.62,.9),e.add(l);for(let t of[-.78,.78]){let n=new J(new Y(.45,.42,.07),Q({color:12445923,emissive:5945522}));n.position.set(t,.92,.91),e.add(n)}let u=new J(new Y(1.28,.32,.1),a);u.position.set(0,1.45,.93),u.castShadow=!0,e.add(u);let d=new J(new Y(.62,.26,.08),t);d.position.set(0,1.45,1),e.add(d);let f=new J(new Ri(.035,.04,1.55,6),i);f.position.set(1.52,1.25,.3),e.add(f);let p=new J(new Y(.55,.32,.05),r);return p.position.set(1.82,1.86,.3),e.add(p),Dl(e,.026),e}function Bl(){let e=new K,t=[Q({color:$.houseWall}),Q({color:$.houseWallAlt}),Q({color:15196104})],n=[Q({color:$.roofA}),Q({color:$.roofB}),Q({color:14200907})];for(let r=0;r<4;r++){let i=-1.8+r*1.18,a=.95+r%2*.25,o=new J(new Y(.95,a,1.05),t[r%t.length]);o.position.set(i,a/2,0),o.castShadow=o.receiveShadow=!0,e.add(o);let s=new J(new zi(.76,.55,4),n[r%n.length]);s.position.set(i,a+.32,0),s.rotation.y=Math.PI/4,s.scale.z=.78,s.castShadow=!0,e.add(s);let c=new J(new Y(.22,.48,.06),Q({color:$.door}));c.position.set(i-.18,.28,.56),e.add(c);let l=new J(new Y(.24,.22,.055),Q({color:12445923,emissive:4893101}));l.position.set(i+.2,a*.62,.56),e.add(l)}let r=Q({color:3116120});for(let t of[-2.45,2]){let n=new J(new Wi(.45,8,6),r);n.position.set(t,.32,.55),n.scale.set(1.2,.65,.55),n.castShadow=!0,e.add(n)}return Dl(e,.022),e}function Vl(){let e=new K,t=Ol();t.scale.setScalar(1.2),t.position.set(0,0,.6),e.add(t);for(let t=0;t<3;t++){let n=new J(new Y(.36,.36,.36),Q({color:t%2?14200907:12158293}));n.position.set(-1+t*.45,.23,-.35+t%2*.22),n.castShadow=!0,e.add(n)}let n=new J(new Y(1.35,.32,.55),Q({color:7049158}));return n.position.set(1.4,.36,1.25),n.rotation.z=.08,n.castShadow=!0,e.add(n),Dl(e,.018),e}var Hl=new Set([`KeyW`,`KeyA`,`KeyS`,`KeyD`,`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`]),Ul=class{down=new Set;onDown=e=>{Hl.has(e.code)&&e.preventDefault(),this.down.add(e.code)};onUp=e=>{this.down.delete(e.code)};constructor(){window.addEventListener(`keydown`,this.onDown),window.addEventListener(`keyup`,this.onUp)}get move(){return(this.down.has(`KeyW`)||this.down.has(`ArrowUp`)?1:0)-(this.down.has(`KeyS`)||this.down.has(`ArrowDown`)?1:0)}get turn(){return(this.down.has(`KeyD`)||this.down.has(`ArrowRight`)?1:0)-(this.down.has(`KeyA`)||this.down.has(`ArrowLeft`)?1:0)}dispose(){window.removeEventListener(`keydown`,this.onDown),window.removeEventListener(`keyup`,this.onUp)}};function Wl(e,t){return t[Math.floor(e()*t.length)]}function Gl(e){let t=new K,n=.7+e()*.4,r=new J(new Ri(.15,.22,n,7),Q({color:$.trunk}));r.position.y=n/2,r.castShadow=!0,t.add(r);let i=2+Math.floor(e()*2),a=n-.1,o=.95+e()*.35;for(let e=0;e<i;e++){let n=.95,r=new J(new zi(o,n,8),Q({color:e%2==0?$.leaf:$.leafAlt}));r.position.y=a+n*.4,r.castShadow=!0,t.add(r),a+=n*.45,o*=.72}return Dl(t,.03),t}function Kl(e){let t=new K,n=.6+e()*.4,r=new J(new Ri(.14,.2,n,7),Q({color:$.trunk}));r.position.y=n/2,r.castShadow=!0,t.add(r);let i=2+Math.floor(e()*2);for(let r=0;r<i;r++){let i=new J(new Wi(.55+e()*.3,9,8),Q({color:e()>.5?$.leaf:$.leafAlt}));i.position.set((e()-.5)*.5,n+.3+r*.28,(e()-.5)*.5),i.scale.y=.9,i.castShadow=!0,t.add(i)}return Dl(t,.03),t}function ql(e){let t=new K,n=1.1+e()*.5,r=1+e()*.4,i=.85+e()*.35,a=new J(new Y(n,i,r),Q({color:e()>.5?$.houseWall:$.houseWallAlt}));a.position.y=i/2,a.castShadow=!0,a.receiveShadow=!0,t.add(a);let o=new J(new zi(Math.max(n,r)*.85,.72,4),Q({color:Wl(e,[$.roofA,$.roofB,$.roofC])}));o.position.y=i+.34,o.rotation.y=Math.PI/4,o.castShadow=!0,t.add(o);let s=new J(new Y(.3,.5,.06),Q({color:$.door}));s.position.set(0,.25,r/2+.02),t.add(s);let c=new J(new Y(.18,.45,.18),Q({color:$.houseWallAlt}));return c.position.set(n*.28,i+.4,r*.2),c.castShadow=!0,t.add(c),Dl(t,.03),t}function Jl(e){let t=new K,n=.3+e()*.35,r=new J(new Vi(n,0),Q({color:9079456}));return r.position.y=n*.55,r.scale.set(1,.7+e()*.3,1),r.rotation.set(e()*3,e()*3,e()*3),r.castShadow=!0,r.receiveShadow=!0,t.add(r),Dl(t,.025),t}function Yl(e){let t=new K,n=2+Math.floor(e()*2);for(let r=0;r<n;r++){let n=.32+e()*.18,r=new J(new Wi(n,8,7),Q({color:e()>.5?$.leafAlt:$.leaf}));r.position.set((e()-.5)*.5,n*.7,(e()-.5)*.5),r.scale.y=.8,r.castShadow=!0,t.add(r)}return Dl(t,.025),t}function Xl(e=$.roofA,t=16773314){let n=new K,r=new J(new Y(.5,.5,.5),Q({color:e}));r.castShadow=!0,n.add(r);let i=Q({color:t}),a=new J(new Y(.54,.1,.54),i),o=new J(new Y(.1,.54,.54),i);return n.add(a,o),Dl(n,.02),n}function Zl(e=$.roofB){let t=new K,n=new J(new Ri(.07,.07,.9,6),Q({color:$.trunk}));n.position.y=.45,n.castShadow=!0,t.add(n);let r=new J(new Y(.4,.3,.55),Q({color:e}));r.position.y=1,r.castShadow=!0,t.add(r);let i=new J(new Y(.04,.18,.14),Q({color:$.beacon}));return i.position.set(.22,1.05,0),t.add(i),Dl(t,.022),t}function Ql(e,t,n){let r=new J(new Ui(e,t,40),new ri({color:n,transparent:!0,opacity:.55,side:2,depthWrite:!1}));return r.rotation.x=-Math.PI/2,r.renderOrder=2,r}function $l(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()}function eu(e){let t=`700 48px Quicksand, "Trebuchet MS", system-ui, sans-serif`,n=document.createElement(`canvas`),r=n.getContext(`2d`);r.font=t;let i=r.measureText(e).width;n.width=Math.ceil(i+60),n.height=88,r.font=t,r.textAlign=`center`,r.textBaseline=`middle`,$l(r,2,2,n.width-4,n.height-4,26),r.fillStyle=`rgba(38, 31, 58, 0.82)`,r.fill(),r.lineWidth=4,r.strokeStyle=`rgba(255, 213, 150, 0.5)`,r.stroke(),r.fillStyle=`#ffffff`,r.fillText(e,n.width/2,n.height/2+3);let a=new Pi(n);a.colorSpace=Le,a.anisotropy=4;let o=new qr(new Nr({map:a,transparent:!0,depthWrite:!1})),s=.85;return o.scale.set(s*(n.width/n.height),s,1),o}var tu=new U(0,1,0),nu=new Ot;function ru(e){let t=e>>>0;return()=>{t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function iu(e,t){let n=(90-e)*Dt.DEG2RAD,r=t*Dt.DEG2RAD;return new U(Math.sin(n)*Math.cos(r),Math.cos(n),Math.sin(n)*Math.sin(r))}function au(e){let t=e()*2-1,n=e()*Math.PI*2,r=Math.sqrt(Math.max(0,1-t*t));return new U(r*Math.cos(n),t,r*Math.sin(n))}function ou(e,t,n,r=0){e.position.copy(t).multiplyScalar(n),e.quaternion.setFromUnitVectors(tu,t),r!==0&&(nu.setFromAxisAngle(t,r),e.quaternion.premultiply(nu))}var su=null,cu=1;function lu(){if(su)return su;let e=ru(24301);su=[],cu=0;for(let t=0;t<6;t++){let n=1/(t+1);su.push({dir:au(e),freq:1.1+t*1.35,phase:e()*Math.PI*2,amp:n}),cu+=n}return su}function uu(e){let t=0;for(let n of lu())t+=n.amp*Math.sin(e.dot(n.dir)*n.freq+n.phase);return t/cu}var du=-.55;function fu(e){return uu(e)>-.5}var pu=new q(4893101),mu=new q(6472637),hu=new q(13223858),gu=new q(5218919),_u=new q(3116120),vu=new q(7649148);function yu(e,t){let n=uu(e);if(n<du){let e=Dt.clamp((du-n)/.5,0,1);return t.copy(mu).lerp(pu,e)}if(n<-.5)return t.copy(hu);if(n<.35){let e=Dt.clamp((n-du)/.4,0,1);return t.copy(_u).lerp(gu,e)}let r=Dt.clamp((n-.35)/.4,0,1);return t.copy(gu).lerp(vu,r)}var bu=class{group=new K;radius=bl.planetRadius;mesh;constructor(){let e=new Vi(this.radius,24),t=e.getAttribute(`position`),n=new Float32Array(t.count*3),r=new Float32Array(t.count*3),i=new U,a=new q;for(let e=0;e<t.count;e++)i.set(t.getX(e),t.getY(e),t.getZ(e)).normalize(),r[e*3]=i.x,r[e*3+1]=i.y,r[e*3+2]=i.z,yu(i,a),n[e*3]=a.r,n[e*3+1]=a.g,n[e*3+2]=a.b;e.setAttribute(`normal`,new hr(r,3)),e.setAttribute(`color`,new hr(n,3)),this.mesh=new J(e,Q({vertexColors:!0})),this.mesh.receiveShadow=!0,this.group.add(this.mesh)}surfacePoint(e,t=new U){return t.copy(e).multiplyScalar(this.radius)}scatter(e,t=[],n=150){let r=[{make:Gl,weight:4},{make:Kl,weight:3},{make:Yl,weight:3},{make:Jl,weight:2},{make:ql,weight:1}],i=r.reduce((e,t)=>e+t.weight,0),a=new U,o=0,s=0;for(;o<n&&s<n*12;){if(s++,a.copy(au(e)),!fu(a))continue;let n=!1;for(let e of t)if(a.angleTo(e)<.13){n=!0;break}if(n)continue;let c=e()*i,l=r[0].make;for(let e of r){if(c<e.weight){l=e.make;break}c-=e.weight}let u=l(e);ou(u,a,this.radius,e()*Math.PI*2),this.group.add(u),o++}}},xu=class{group=new K;model=new K;up=new U(0,1,0);forward=new U(0,0,1);right=new U(1,0,0);position=new U;radius=bl.planetRadius;basis=new Xt;q=new Ot;axis=new U;bobPhase=0;constructor(e){this.buildModel(),this.group.add(this.model),this.reset(e)}reset(e){this.up.copy(e).normalize(),this.forward.set(0,1,0),Math.abs(this.up.dot(this.forward))>.9&&this.forward.set(1,0,0),this.forward.addScaledVector(this.up,-this.forward.dot(this.up)).normalize(),this.bobPhase=0,this.sync(0,0)}update(e,t,n){n!==0&&(this.q.setFromAxisAngle(this.up,-n*bl.turnSpeed*e),this.forward.applyQuaternion(this.q));let r=0;if(t!==0){let n=t*bl.walkSpeed*e/this.radius;this.axis.copy(this.up).cross(this.forward).normalize(),this.q.setFromAxisAngle(this.axis,n),this.up.applyQuaternion(this.q),this.forward.applyQuaternion(this.q),r=Math.abs(t)}this.up.normalize(),this.forward.addScaledVector(this.up,-this.forward.dot(this.up)).normalize(),this.sync(e,r)}sync(e,t){this.right.copy(this.up).cross(this.forward).normalize(),this.position.copy(this.up).multiplyScalar(this.radius),this.group.position.copy(this.position),this.basis.makeBasis(this.right,this.up,this.forward),this.group.quaternion.setFromRotationMatrix(this.basis),this.bobPhase+=e*t*14;let n=t>0?Math.abs(Math.sin(this.bobPhase))*.12:0;this.model.position.y=n,this.model.rotation.z=t>0?Math.sin(this.bobPhase)*.05:0}buildModel(){let e=this.model,t=new Ri(.12,.12,.45,7);for(let n of[-1,1]){let r=new J(t,Q({color:$.courierHat}));r.position.set(n*.17,.225,0),r.castShadow=!0,e.add(r)}let n=new J(new Y(.7,.78,.46),Q({color:$.courierBody}));n.position.y=.84,n.castShadow=!0,e.add(n);let r=new J(new Y(.58,.56,.3),Q({color:$.courierBag}));r.position.set(0,.92,-.34),r.castShadow=!0,e.add(r);let i=new J(new Y(.12,.9,.5),Q({color:$.courierBag}));i.position.set(.12,.92,0),i.rotation.z=.18,e.add(i);let a=new J(new Wi(.3,12,10),Q({color:$.courierSkin}));a.position.y=1.46,a.castShadow=!0,e.add(a);let o=new J(new Ri(.34,.34,.07,14),Q({color:$.courierHat}));o.position.y=1.66,o.castShadow=!0,e.add(o);let s=new J(new zi(.27,.34,14),Q({color:$.courierHat}));s.position.y=1.86,s.castShadow=!0,e.add(s);let c=new J(new Wi(.07,8,6),Q({color:$.courierSkin}));c.position.set(0,1.42,.29),e.add(c),Dl(e,.025)}},Su=[$.roofA,$.roofB,$.roofC],Cu=class{group=new K;deliveries=[];activeIndex=0;constructor(e,t=bl.planetRadius){e.forEach((e,n)=>{let r=this.build(e.dir,e.name,t,n);this.deliveries.push(r),this.group.add(r.group)}),this.refreshVisibility()}get total(){return this.deliveries.length}get delivered(){return this.deliveries.filter(e=>e.done).length}get complete(){return this.delivered>=this.total}active(){return this.deliveries[this.activeIndex]??null}update(e,t,n){let r=this.active();return!r||r.done?null:(r.parcel.position.y=1.7+Math.sin(n*2)*.18,r.parcel.rotation.y+=t*1.2,r.ring.scale.setScalar(1+Math.sin(n*3)*.06),e.distanceTo(r.position)<=bl.deliverRadius?(r.done=!0,this.activeIndex++,this.refreshVisibility(),r):null)}reset(){this.activeIndex=0;for(let e of this.deliveries)e.done=!1,e.parcel.position.y=1.7,e.parcel.rotation.y=0,e.ring.scale.setScalar(1);this.refreshVisibility()}build(e,t,n,r){let i=new K;ou(i,e,n);let a=Su[r%Su.length],o=Zl(a);i.add(o);let s=Ql(1.4,2,$.beacon);s.position.y=.02,i.add(s);let c=Xl(a);c.position.y=1.7,i.add(c);let l=eu(t);l.position.y=2.7,i.add(l);let u=new J(new Ri(.13,.13,8,12,1,!0),new ri({color:$.beacon,transparent:!0,opacity:.16,depthWrite:!1,side:2,blending:2}));return u.position.y=4,i.add(u),{dir:e.clone(),position:e.clone().multiplyScalar(n),name:t,group:i,ring:s,ringMat:s.material,parcel:c,label:l,pillar:u,done:!1}}refreshVisibility(){this.deliveries.forEach((e,t)=>{let n=t===this.activeIndex;e.done?(e.ringMat.color.set($.beaconDone),e.ringMat.opacity=.5):(e.ringMat.color.set($.beacon),e.ringMat.opacity=n?.55:.18),e.parcel.visible=n&&!e.done,e.pillar.visible=n&&!e.done,e.label.visible=n||e.done})}},wu=`
  varying vec3 vDir;
  void main() {
...
`;function Eu(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.3,`rgba(255,250,230,0.9)`),n.addColorStop(1,`rgba(255,250,230,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Pi(e)}var Du=class{group=new K;sunDirection=new U(.55,.72,.42).normalize();stars;starMaterial;domeMaterial;constructor(e=170){this.domeMaterial=new ea({uniforms:{topColor:{value:new q($.skyZenith)},midColor:{value:new q($.skyMid)},botColor:{value:new q($.skyHorizon)},sunColor:{value:new q($.sunGlow)},sunDir:{value:this.sunDirection}},vertexShader:wu,fragmentShader:Tu,side:1,depthWrite:!1,fog:!1});let t=new J(new Wi(e,32,24),this.domeMaterial);t.renderOrder=-1,this.group.add(t);let n=new Float32Array(720*3),r=new Float32Array(720*3),i=ru(22436),a=new q($.star),o=new q(12571903),s=new q,c=e*.92;for(let e=0;e<720;e++){let t=au(i);n[e*3]=t.x*c,n[e*3+1]=t.y*c,n[e*3+2]=t.z*c,s.copy(a).lerp(o,i()*.6),r[e*3]=s.r,r[e*3+1]=s.g,r[e*3+2]=s.b}let l=new Dr;l.setAttribute(`position`,new hr(n,3)),l.setAttribute(`color`,new hr(r,3)),this.starMaterial=new Ei({size:2.2,map:Eu(),vertexColors:!0,transparent:!0,depthWrite:!1,sizeAttenuation:!1,blending:2}),this.stars=new ji(l,this.starMaterial),this.stars.renderOrder=-1,this.group.add(this.stars)}update(e,t){this.stars.rotation.y+=e*.006,this.starMaterial.opacity=.65+.3*Math.sin(t*.7)}},Ou=`An original prototype — every shape, colour, and line of code is generated from primitives in this repository. No third-party game assets, source, or layouts are used or copied. Not affiliated with any existing game.`;function ku(e,t={}){let n=document.createElement(e);return t.className&&(n.className=t.className),t.id&&(n.id=t.id),t.html!==void 0&&(n.innerHTML=t.html),n}var Au=class{onStart=()=>{};onReplay=()=>{};overlay;card;hud;objectiveText;objectiveHint;countDone;countTotal;compass;needle;dist;toast;touch;fwd=!1;back=!1;left=!1;right=!1;toastTimer=0;constructor(e){this.card=ku(`div`,{className:`card`}),this.overlay=ku(`div`,{className:`overlay`,id:`overlay`}),this.overlay.appendChild(this.card),this.hud=ku(`div`,{id:`hud`}),this.hud.appendChild(ku(`div`,{className:`hud-panel`,id:`hud-objective`,html:`<div class="label-tiny">Objective</div><div id="objective-text">Getting ready…</div><div id="objective-hint"></div>`})),this.hud.appendChild(ku(`div`,{className:`hud-panel`,id:`hud-count`,html:`<div class="label-tiny">Delivered</div><div id="count-value"><span id="count-done">0</span><span class="total" id="count-total">/3</span></div>`})),this.compass=ku(`div`,{id:`compass`,html:`<div class="ring"></div><div class="needle" id="needle"></div><div class="dist" id="dist">--</div>`}),this.toast=ku(`div`,{id:`toast`}),this.touch=ku(`div`,{id:`touch`,html:`<button class="touch-btn" id="t-fwd" aria-label="forward">▲</button><button class="touch-btn" id="t-back" aria-label="back">▼</button><button class="touch-btn" id="t-left" aria-label="left">◀</button><button class="touch-btn" id="t-right" aria-label="right">▶</button>`});let t=ku(`div`,{className:`hint`,html:`WASD / arrow keys to move • reach the glowing mailbox to deliver`});e.append(this.overlay,this.hud,this.compass,this.toast,this.touch,t),this.objectiveText=this.req(`objective-text`),this.objectiveHint=this.req(`objective-hint`),this.countDone=this.req(`count-done`),this.countTotal=this.req(`count-total`),this.needle=this.req(`needle`),this.dist=this.req(`dist`),this.bindTouch(),window.matchMedia(`(pointer: coarse)`).matches&&document.body.classList.add(`touch`)}get touchMove(){return!!this.fwd-+!!this.back}get touchTurn(){return!!this.right-+!!this.left}get overlayVisible(){return!this.overlay.classList.contains(`hidden`)}showStart(){this.card.innerHTML=`<div class="art-preview poster"><img src="./concept-art-v2.png" alt="Courier town art direction concept" /></div><h1>Courier Town</h1><div class="subtitle">A compact hand-painted delivery neighborhood</div><p>Deliver parcels through a dense little town of markets, post roads, harbor lanes, trees, and glowing mailboxes.</p><div class="controls"><span class="key"><kbd>W</kbd><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd> / arrows — walk &amp; turn</span><span class="key"><kbd>Enter</kbd> — start</span></div><button class="btn" id="start-btn">Start delivering</button><p class="fine-print">${Ou}</p>`,this.overlay.classList.remove(`hidden`),this.card.querySelector(`#start-btn`)?.addEventListener(`click`,()=>this.onStart())}showComplete(e,t){this.card.innerHTML=`<h1>All delivered! 🎉</h1><div class="subtitle">Tiny Planet Messenger</div><p>You delivered all ${e} parcels in <strong>${t}</strong>. The little world thanks you.</p><button class="btn" id="replay-btn">Play again</button>`,this.overlay.classList.remove(`hidden`),this.card.querySelector(`#replay-btn`)?.addEventListener(`click`,()=>this.onReplay())}hideOverlay(){this.overlay.classList.add(`hidden`)}showHud(e){this.hud.classList.toggle(`show`,e)}showCompass(e){this.compass.classList.toggle(`show`,e)}activateTouch(){this.touch.classList.add(`active`)}setObjective(e,t){this.objectiveText.textContent=e,this.objectiveHint.textContent=t}setCount(e,t){this.countDone.textContent=String(e),this.countTotal.textContent=`/${t}`}updateCompass(e,t){this.needle.style.transform=`translate(-50%, -100%) rotate(${e}deg)`,this.dist.textContent=`${Math.round(t)}m`}showToast(e){this.toast.textContent=e,this.toast.classList.add(`show`),window.clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>{this.toast.classList.remove(`show`)},1600)}req(e){let t=document.getElementById(e);if(!t)throw Error(`UI element #${e} missing`);return t}bindTouch(){let e=(e,t)=>{let n=this.req(e),r=e=>{e.preventDefault(),t(!0)},i=()=>t(!1);n.addEventListener(`pointerdown`,r),n.addEventListener(`pointerup`,i),n.addEventListener(`pointerleave`,i),n.addEventListener(`pointercancel`,i)};e(`t-fwd`,e=>this.fwd=e),e(`t-back`,e=>this.back=e),e(`t-left`,e=>this.left=e),e(`t-right`,e=>this.right=e)}},ju=-10,Mu=104;function Nu(e,t){return iu(ju+t/bl.planetRadius*Dt.RAD2DEG,Mu+e/(bl.planetRadius*Math.cos(ju*Dt.DEG2RAD))*Dt.RAD2DEG)}var Pu=Nu(0,-24),Fu=[{name:`Harbor Post`,dir:Nu(30,-34)},{name:`Hill Shrine`,dir:Nu(-42,26)},{name:`Forest Mill`,dir:Nu(48,34)}];function Iu(e){return Math.max(-1,Math.min(1,e))}function Lu(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}var Ru=class{renderer;scene=new Nn;camera=new Pa(48,1,.1,500);clock=new eo;keyboard=new Ul;ui;sky=new Du;planet=new bu;player=new xu(Pu);quests=new Cu(Fu);tmp=new U;tmp2=new U;camTarget=new U;lookTarget=new U;running=!1;playing=!1;elapsed=0;playStartedAt=0;root;constructor(e){this.root=e,this.renderer=new yl({antialias:!0,alpha:!1}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.outputColorSpace=Le,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.08,this.renderer.setClearColor($.skyZenith,1),this.scene.background=new q($.skyZenith),this.scene.fog=new Mn($.skyZenith,.0055),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.root.appendChild(this.renderer.domElement),this.ui=new Au(e),this.ui.onStart=()=>this.beginRun(),this.ui.onReplay=()=>this.beginRun(),this.buildScene(),this.bindEvents(),this.resize(),this.updateHud(),this.ui.showStart()}start(){this.running||(this.running=!0,this.clock.start(),this.renderer.setAnimationLoop(()=>this.frame()))}dispose(){this.running=!1,this.renderer.setAnimationLoop(null),this.keyboard.dispose(),window.removeEventListener(`resize`,this.resize),this.renderer.dispose()}buildScene(){this.scene.add(this.sky.group);let e=new Sa($.hemiSky,$.hemiGround,2.1);this.scene.add(e);let t=new La($.sunLight,4.2);t.position.copy(this.sky.sunDirection).multiplyScalar(60),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.near=5,t.shadow.camera.far=140,t.shadow.camera.left=-28,t.shadow.camera.right=28,t.shadow.camera.top=28,t.shadow.camera.bottom=-28,this.scene.add(t),this.scene.add(this.planet.group),this.scene.add(this.quests.group),this.scene.add(this.player.group),this.planet.scatter(ru(11256099),[Pu,...Fu.map(e=>e.dir)],28),this.placeNeighborhoodDistrict(),this.placeAuthoredDetails(),this.placeCamera(1)}placeNeighborhoodDistrict(){let e=ru(29097);for(let e=-54;e<=52;e+=4.2){let t=jl();t.scale.set(7,1,3.2),ou(t,Nu(0,e),bl.planetRadius+.04,.05),this.scene.add(t)}for(let e of[-42,-24,-8,10,28,44])for(let t=-58;t<=58;t+=4.2){let n=jl();n.scale.set(6.4,1,3),ou(n,Nu(t,e),bl.planetRadius+.045,Math.PI/2),this.scene.add(n)}for(let t of[{north:-48,easts:[-48,-36,-22,20,34,48],spin:.2},{north:-32,easts:[-54,-40,-26,18,32,50],spin:-.25},{north:-16,easts:[-46,-30,-16,16,30,46],spin:.35},{north:4,easts:[-54,-38,-20,20,38,54],spin:-.3},{north:22,easts:[-46,-30,-14,14,30,46],spin:.15},{north:40,easts:[-38,-22,22,38],spin:-.15}])for(let n of t.easts){let r=ql(e);r.scale.setScalar(2.4+e()*.8),ou(r,Nu(n,t.north),bl.planetRadius+.055,t.spin+(e()-.5)*.7),this.scene.add(r)}for(let e=0;e<18;e++){let t=e/18*Math.PI*2,n=Ml();n.scale.setScalar(1.8),ou(n,Nu(Math.cos(t)*12,-10+Math.sin(t)*8),bl.planetRadius+.055,t),this.scene.add(n)}for(let[e,t,n]of[[-12,-24,.2],[12,-24,-.35],[-14,-8,.45],[14,-8,-.25],[-16,10,.2],[16,10,-.2]]){let r=Fl();r.scale.setScalar(1.35),ou(r,Nu(e,t),bl.planetRadius+.06,n),this.scene.add(r)}let t=Ll();t.scale.setScalar(2.15),ou(t,Nu(0,-8),bl.planetRadius+.07,0),this.scene.add(t);let n=zl();n.scale.setScalar(2.25),ou(n,Nu(0,-36),bl.planetRadius+.08,.03),this.scene.add(n);for(let[e,t,n]of[[-36,-34,.08],[36,-34,-.1],[-44,-4,Math.PI/2],[44,4,-Math.PI/2],[-34,30,.18],[34,32,-.18]]){let r=Bl();r.scale.setScalar(2.05),ou(r,Nu(e,t),bl.planetRadius+.075,n),this.scene.add(r)}let r=Vl();r.scale.setScalar(2.3),ou(r,Nu(32,-44),bl.planetRadius+.075,-.3),this.scene.add(r);let i=[$.roofA,$.roofB,$.roofC,15905357];for(let[e,t,n,r]of[[0,-18,-14,.55],[1,-8,-2,-.3],[2,10,-2,.2],[3,20,-14,-.55],[1,-20,14,.35],[2,22,14,-.35]]){let a=Il(i[e]);a.scale.setScalar(1.9),ou(a,Nu(t,n),bl.planetRadius+.065,r),this.scene.add(a)}for(let[e,t,n]of[[-6,-42,.1],[8,-42,-.1],[-56,-8,Math.PI/2],[56,10,-Math.PI/2],[-28,44,.4],[30,44,-.4]]){let r=Rl();r.scale.setScalar(1.55),ou(r,Nu(e,t),bl.planetRadius+.07,n),this.scene.add(r)}}placeAuthoredDetails(){let e=[{dir:Fu[0].dir,make:Ol,spin:-.35,scale:2.2},{dir:Fu[1].dir,make:kl,spin:.55,scale:2},{dir:Fu[2].dir,make:Al,spin:.1,scale:1.9}];for(let t of e){let e=t.make();e.scale.setScalar(t.scale),ou(e,t.dir,bl.planetRadius+.025,t.spin),this.scene.add(e)}let t=Nl();t.scale.setScalar(2.45),ou(t,Nu(16,-4),bl.planetRadius+.03,-.9),this.scene.add(t);let n=Pl();n.scale.setScalar(1.65),ou(n,Nu(-34,20),bl.planetRadius+.045,.35),this.scene.add(n);let r=Pl();r.scale.setScalar(1.32),ou(r,Nu(-44,28),bl.planetRadius+.045,.5),this.scene.add(r);for(let e=0;e<12;e++){let t=e/11,n=Pu.clone().lerp(Fu[0].dir,t).normalize(),r=jl();if(r.scale.setScalar(2.4+t*.55),ou(r,n,bl.planetRadius+.035,-.4+t*1.1),this.scene.add(r),e%3==1){let e=Fl();e.scale.setScalar(1.25),ou(e,n,bl.planetRadius+.055,-.4+t*1.1),this.scene.add(e)}}let i=[Nu(-24,-18),Nu(-8,-18),Nu(8,-18),Nu(24,-18),Nu(-28,18),Nu(28,18)];for(let e of i){let t=Ml();t.scale.setScalar(1.35),ou(t,e,bl.planetRadius+.04,Math.random()*Math.PI),this.scene.add(t)}}bindEvents(){window.addEventListener(`resize`,this.resize),window.addEventListener(`keydown`,e=>{e.code===`Enter`&&this.ui.overlayVisible&&(e.preventDefault(),this.beginRun())})}resize=()=>{let e=Math.max(1,this.root.clientWidth||window.innerWidth),t=Math.max(1,this.root.clientHeight||window.innerHeight);this.camera.aspect=e/t,this.camera.fov=e<700?58:48,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1)};beginRun(){this.player.reset(Pu),this.quests.reset(),this.elapsed=0,this.playStartedAt=this.clock.elapsedTime,this.playing=!0,this.ui.hideOverlay(),this.ui.showHud(!0),this.ui.showCompass(!0),this.ui.activateTouch(),this.ui.showToast(`First parcel loaded — follow the glow!`),this.updateHud(),this.placeCamera(1)}frame(){let e=Math.min(this.clock.getDelta(),.04);if(this.elapsed=this.clock.elapsedTime,this.sky.update(e,this.elapsed),this.playing){let t=Iu(this.keyboard.move+this.ui.touchMove),n=Iu(this.keyboard.turn+this.ui.touchTurn);this.player.update(e,t,n);let r=this.quests.update(this.player.position,e,this.elapsed);r&&(this.ui.showToast(`Delivered to ${r.name}!`),this.updateHud(),this.quests.complete&&(this.playing=!1,this.ui.showComplete(this.quests.total,Lu(this.clock.elapsedTime-this.playStartedAt)),this.ui.showCompass(!1))),this.updateCompass()}this.placeCamera(e),this.renderer.render(this.scene,this.camera)}placeCamera(e){let t=e>=1?1:1-Math.exp(-bl.camLerp*e);this.camTarget.copy(this.player.position).addScaledVector(this.player.up,bl.camHeight).addScaledVector(this.player.forward,-bl.camDistance),this.camera.position.lerp(this.camTarget,t),this.lookTarget.copy(this.player.position).addScaledVector(this.player.up,1.55).addScaledVector(this.player.forward,bl.camLookAhead),this.camera.up.copy(this.player.up),this.camera.lookAt(this.lookTarget)}updateHud(){let e=this.quests.active();e?this.ui.setObjective(`Deliver parcel to ${e.name}`,`Look for the glowing mailbox beacon.`):this.ui.setObjective(`All routes complete`,`Replay to run the route again.`),this.ui.setCount(this.quests.delivered,this.quests.total)}updateCompass(){let e=this.quests.active();if(!e||(this.tmp.copy(e.dir).addScaledVector(this.player.up,-e.dir.dot(this.player.up)),this.tmp.lengthSq()<1e-6))return;this.tmp.normalize();let t=Dt.clamp(this.tmp.dot(this.player.forward),-1,1),n=this.tmp.dot(this.player.right),r=Dt.radToDeg(Math.atan2(n,t)),i=this.player.up.angleTo(e.dir)*bl.planetRadius;this.tmp2.copy(e.position).sub(this.player.position);let a=Math.min(i,this.tmp2.length());this.ui.updateCompass(r,a)}},zu=document.querySelector(`#app`);if(!zu)throw Error(`Missing #app mount point`);new Ru(zu).start();