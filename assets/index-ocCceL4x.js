...
void main() {
	...
	`}var Fo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Mi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function El(e,t=.04,n=xl){let r=new ea({uniforms:{thickness:{value:t},outlineColor:{value:new q(n)}},vertexShader:wl,fragmentShader:Tl,side:1}),i=new Y(e.geometry,r);return i.castShadow=!1,i.receiveShadow=!1,i.userData.isOutline=!0,i.renderOrder=(e.renderOrder??0)-1,e.add(i),i}function Dl(e,t=.04,n=xl){let r=[];e.traverse(e=>{let t=e;t.isMesh&&!e.userData.isOutline&&r.push(t)});for(let e of r)El(e,t,n)}var $={skyZenith:2828885,skyHorizon:16757370,skyMid:9400240,sunGlow:16773577,sunLight:16773846,hemiSky:12175359,hemiGround:4877114,ambient:5991050,land:7323507,landDark:5217642,highland:10212474,sand:15259034,water:4961220,waterDeep:3114662,trunk:10251074,leaf:6270554,leafAlt:8309099,houseWall:15983555,houseWallAlt:14270368,roofA:13987674,roofB:6981316,roofC:13208245,door:8016438,pathRing:15324840,cloud:16645375,star:16774872,courierBody:4161494,courierBag:13128764,courierSkin:15910810,courierHat:3108751,beacon:16765503,beaconDone:9429896,markerRing:16773288};function Ol(){let e=new wn,t=Q({color:12158293}),n=Q({color:15982519}),r=Q({color:$.roofA}),i=new Y(new Li(3,.18,1.05),t);i.position.set(0,.12,.15),i.castShadow=i.receiveShadow=!0,e.add(i);for(let t of[-1.25,-.35,.55,1.35]){let n=new Y(new Li(.1,.08,1.18),Q({color:13934699}));n.position.set(t,.27,.15),n.castShadow=!0,e.add(n)}for(let n of[-1.35,1.35]){let i=new Y(new Ri(.09,.11,.9,7),t);i.position.set(n,.55,-.48),i.castShadow=!0,e.add(i);let a=new Y(new Wi(.16,8,6),r);a.position.set(n,1.04,-.48),a.castShadow=!0,e.add(a)}let a=new Y(new Li(1.15,.28,.42),Q({color:6200278}));a.position.set(.3,.38,.95),a.rotation.z=.08,a.castShadow=!0,e.add(a);let o=new Y(new zi(.38,.9,3),n);return o.position.set(.34,.95,.93),o.rotation.y=Math.PI/6,o.castShadow=!0,e.add(o),Dl(e,.026),e}function kl(){let e=new wn,t=Q({color:14241085}),n=Q({color:16771003}),r=Q({color:10920631}),i=new Y(new Li(1.9,.18,1.45),r);i.position.y=.12,i.castShadow=i.receiveShadow=!0,e.add(i);for(let n of[-.72,.72]){let r=new Y(new Ri(.11,.14,1.6,8),t);r.position.set(n,.9,0),r.castShadow=!0,e.add(r)}let a=new Y(new Li(2.15,.2,.24),t);a.position.set(0,1.62,0),a.castShadow=!0,e.add(a);let o=new Y(new Li(2.55,.16,.32),n);o.position.set(0,1.86,0),o.castShadow=!0,e.add(o);let s=new Y(new zi(.22,.34,12),Q({color:$.beacon}));return s.position.set(0,1.33,0),s.castShadow=!0,e.add(s),Dl(e,.026),e}function Al(){let e=new wn,t=Q({color:15915189}),n=Q({color:$.roofB}),r=Q({color:$.trunk}),i=new Y(new Ri(.62,.78,1.65,8),t);i.position.y=.86,i.castShadow=i.receiveShadow=!0,e.add(i);let a=new Y(new zi(.86,.72,8),n);a.position.y=2.02,a.castShadow=!0,e.add(a);let o=new Y(new Ri(.12,.12,.16,10),r);o.position.set(0,1.45,.68),o.rotation.x=Math.PI/2,o.castShadow=!0,e.add(o);for(let t=0;t<4;t++){let n=new Y(new Li(.13,.78,.08),r);n.position.set(0,1.45,.78),n.rotation.z=Math.PI/2*t+Math.PI/5,n.castShadow=!0,e.add(n)}let s=new Y(new Gi(.82,.025,6,40),Q({color:16773314}));return s.position.set(0,.1,0),s.rotation.x=Math.PI/2,e.add(s),Dl(e,.026),e}function jl(){let e=new wn,t=new Y(new Li(1.15,.055,.66),Q({color:15774598}));return t.position.y=.055,t.castShadow=!1,t.receiveShadow=!0,e.add(t),Dl(e,.012),e}function Ml(){let e=new wn,t=[16766541,16747198,10213375,16777215];for(let n=0;n<8;n++){let r=new Y(new Ri(.012,.015,.22,5),Q({color:5020501})),i=n/8*Math.PI*2,a=.15+n%3*.09;r.position.set(Math.cos(i)*a,.11,Math.sin(i)*a),e.add(r);let o=new Y(new Wi(.045,6,5),Q({color:t[n%t.length]}));o.position.set(r.position.x,.24,r.position.z),e.add(o)}return e}function Nl(){let e=new wn,t=Q({color:9396037}),n=Q({color:7293240}),r=Q({color:16758480}),i=Q({color:16766435}),a=Q({color:16749757}),o=new Y(new Ri(.24,.34,1.75,8),t);o.position.y=.85,o.rotation.z=-.08,o.castShadow=!0,e.add(o);for(let t=0;t<5;t++){let r=new Y(new Ri(.06,.1,1.05,7),n);r.position.set((t-2)*.18,1.45+t%2*.12,0),r.rotation.z=-.72+t*.36,r.rotation.x=t%2==0?.32:-.28,r.castShadow=!0,e.add(r)}let s=[[-.55,2,0,.72,r],[.15,2.25,.08,.88,i],[.72,1.96,-.05,.7,r],[-.05,1.82,.44,.62,a],[.1,1.86,-.5,.62,r]];for(let[t,n,r,i,a]of s){let o=new Y(new Wi(i,12,10),a);o.position.set(t,n,r),o.scale.y=.82,o.castShadow=!0,e.add(o)}for(let t=0;t<18;t++){let n=new Y(new Li(.12,.018,.07),t%3==0?a:i),r=t/18*Math.PI*2,o=.9+t%4*.18;n.position.set(Math.cos(r)*o,.18+t%5*.08,Math.sin(r)*o),n.rotation.set(.15*t,r,.4),e.add(n)}return Dl(e,.028),e}function Pl(){let e=new wn,t=Q({color:14241085}),n=Q({color:8203562}),r=Q({color:$.beacon});for(let n of[-.55,.55]){let r=new Y(new Ri(.08,.1,1.05,8),t);r.position.set(n,.54,0),r.castShadow=!0,e.add(r)}let i=new Y(new Li(1.55,.16,.22),t);i.position.y=1.1,i.castShadow=!0,e.add(i);let a=new Y(new Li(1.9,.12,.28),n);a.position.y=1.28,a.castShadow=!0,e.add(a);let o=new Y(new Li(.26,.32,.08),r);return o.position.set(0,.88,.13),o.castShadow=!0,e.add(o),Dl(e,.024),e}function Fl(){let e=new wn,t=Q({color:12234912}),n=Q({color:16767114,emissive:16754779});for(let r of[-.36,.36]){let i=new Y(new Ri(.045,.06,.55,6),t);i.position.set(r,.28,0),i.castShadow=!0;let a=new Y(new Li(.22,.24,.22),n);a.position.set(r,.66,0),a.castShadow=!0;let o=new Y(new zi(.18,.16,4),t);o.position.set(r,.86,0),o.rotation.y=Math.PI/4,o.castShadow=!0,e.add(i,a,o)}return Dl(e,.018),e}var Il=new Set([`KeyW`,`KeyA`,`KeyS`,`KeyD`,`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`]),Ll=class{down=new Set;onDown=e=>{Il.has(e.code)&&e.preventDefault(),this.down.add(e.code)};onUp=e=>{this.down.delete(e.code)};constructor(){window.addEventListener(`keydown`,this.onDown),window.addEventListener(`keyup`,this.onUp)}get move(){return(this.down.has(`KeyW`)||this.down.has(`ArrowUp`)?1:0)-(this.down.has(`KeyS`)||this.down.has(`ArrowDown`)?1:0)}get turn(){return(this.down.has(`KeyD`)||this.down.has(`ArrowRight`)?1:0)-(this.down.has(`KeyA`)||this.down.has(`ArrowLeft`)?1:0)}dispose(){window.removeEventListener(`keydown`,this.onDown),window.removeEventListener(`keyup`,this.onUp)}};function Rl(e,t){return t[Math.floor(e()*t.length)]}function zl(e){let t=new wn,n=.7+e()*.4,r=new Y(new Ri(.15,.22,n,7),Q({color:$.trunk}));r.position.y=n/2,r.castShadow=!0,t.add(r);let i=2+Math.floor(e()*2),a=n-.1,o=.95+e()*.35;for(let e=0;e<i;e++){let n=.95,r=new Y(new zi(o,n,8),Q({color:e%2==0?$.leaf:$.leafAlt}));r.position.y=a+n*.4,r.castShadow=!0,t.add(r),a+=n*.45,o*=.72}return Dl(t,.03),t}function Bl(e){let t=new wn,n=.6+e()*.4,r=new Y(new Ri(.14,.2,n,7),Q({color:$.trunk}));r.position.y=n/2,r.castShadow=!0,t.add(r);let i=2+Math.floor(e()*2);for(let r=0;r<i;r++){let i=new Y(new Wi(.55+e()*.3,9,8),Q({color:e()>.5?$.leaf:$.leafAlt}));i.position.set((e()-.5)*.5,n+.3+r*.28,(e()-.5)*.5),i.scale.y=.9,i.castShadow=!0,t.add(i)}return Dl(t,.03),t}function Vl(e){let t=new wn,n=1.1+e()*.5,r=1+e()*.4,i=.85+e()*.35,a=new Y(new Li(n,i,r),Q({color:e()>.5?$.houseWall:$.houseWallAlt}));a.position.y=i/2,a.castShadow=!0,a.receiveShadow=!0,t.add(a);let o=new Y(new zi(Math.max(n,r)*.85,.72,4),Q({color:Rl(e,[$.roofA,$.roofB,$.roofC])}));o.position.y=i+.34,o.rotation.y=Math.PI/4,o.castShadow=!0,t.add(o);let s=new Y(new Li(.3,.5,.06),Q({color:$.door}));s.position.set(0,.25,r/2+.02),t.add(s);let c=new Y(new Li(.18,.45,.18),Q({color:$.houseWallAlt}));return c.position.set(n*.28,i+.4,r*.2),c.castShadow=!0,t.add(c),Dl(t,.03),t}function Hl(e){let t=new wn,n=.3+e()*.35,r=new Y(new Vi(n,0),Q({color:9079456}));return r.position.y=n*.55,r.scale.set(1,.7+e()*.3,1),r.rotation.set(e()*3,e()*3,e()*3),r.castShadow=!0,r.receiveShadow=!0,t.add(r),Dl(t,.025),t}function Ul(e){let t=new wn,n=2+Math.floor(e()*2);for(let r=0;r<n;r++){let n=.32+e()*.18,r=new Y(new Wi(n,8,7),Q({color:e()>.5?$.leafAlt:$.leaf}));r.position.set((e()-.5)*.5,n*.7,(e()-.5)*.5),r.scale.y=.8,r.castShadow=!0,t.add(r)}return Dl(t,.025),t}function Wl(e=$.roofA,t=16773314){let n=new wn,r=new Y(new Li(.5,.5,.5),Q({color:e}));r.castShadow=!0,n.add(r);let i=Q({color:t}),a=new Y(new Li(.54,.1,.54),i),o=new Y(new Li(.1,.54,.54),i);return n.add(a,o),Dl(n,.02),n}function Gl(e=$.roofB){let t=new wn,n=new Y(new Ri(.07,.07,.9,6),Q({color:$.trunk}));n.position.y=.45,n.castShadow=!0,t.add(n);let r=new Y(new Li(.4,.3,.55),Q({color:e}));r.position.y=1,r.castShadow=!0,t.add(r);let i=new Y(new Li(.04,.18,.14),Q({color:$.beacon}));return i.position.set(.22,1.05,0),t.add(i),Dl(t,.022),t}function Kl(e,t,n){let r=new Y(new Ui(e,t,40),new ni({color:n,transparent:!0,opacity:.55,side:2,depthWrite:!1}));return r.rotation.x=-Math.PI/2,r.renderOrder=2,r}function ql(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()}function Jl(e){let t=`700 48px Quicksand, "Trebuchet MS", system-ui, sans-serif`,n=document.createElement(`canvas`),r=n.getContext(`2d`);r.font=t;let i=r.measureText(e).width;n.width=Math.ceil(i+60),n.height=88,r.font=t,r.textAlign=`center`,r.textBaseline=`middle`,ql(r,2,2,n.width-4,n.height-4,26),r.fillStyle=`rgba(38, 31, 58, 0.82)`,r.fill(),r.lineWidth=4,r.strokeStyle=`rgba(255, 213, 150, 0.5)`,r.stroke(),r.fillStyle=`#ffffff`,r.fillText(e,n.width/2,n.height/2+3);let a=new Ni(n);a.colorSpace=Le,a.anisotropy=4;let o=new Kr(new Mr({map:a,transparent:!0,depthWrite:!1})),s=.85;return o.scale.set(s*(n.width/n.height),s,1),o}var Yl=new W(0,1,0),Xl=new Dt;function Zl(e){let t=e>>>0;return()=>{t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function Ql(e,t){let n=(90-e)*Et.DEG2RAD,r=t*Et.DEG2RAD;return new W(Math.sin(n)*Math.cos(r),Math.cos(n),Math.sin(n)*Math.sin(r))}function $l(e){let t=e()*2-1,n=e()*Math.PI*2,r=Math.sqrt(Math.max(0,1-t*t));return new W(r*Math.cos(n),t,r*Math.sin(n))}function eu(e,t,n,r=0){e.position.copy(t).multiplyScalar(n),e.quaternion.setFromUnitVectors(Yl,t),r!==0&&(Xl.setFromAxisAngle(t,r),e.quaternion.premultiply(Xl))}var tu=null,nu=1;function ru(){if(tu)return tu;let e=Zl(24301);tu=[],nu=0;for(let t=0;t<6;t++){let n=1/(t+1);tu.push({dir:$l(e),freq:1.1+t*1.35,phase:e()*Math.PI*2,amp:n}),nu+=n}return tu}function iu(e){let t=0;for(let n of ru())t+=n.amp*Math.sin(e.dot(n.dir)*n.freq+n.phase);return t/nu}var au=-.55;function ou(e){return iu(e)>-.5}var su=new q(3114662),cu=new q(4961220),lu=new q(15259034),uu=new q(7323507),du=new q(5744746),fu=new q(10212474);function pu(e,t){let n=iu(e);if(n<au){let e=Et.clamp((au-n)/.5,0,1);return t.copy(cu).lerp(su,e)}if(n<-.5)return t.copy(lu);if(n<.35){let e=Et.clamp((n-au)/.4,0,1);return t.copy(du).lerp(uu,e)}let r=Et.clamp((n-.35)/.4,0,1);return t.copy(uu).lerp(fu,r)}var mu=class{group=new wn;radius=bl.planetRadius;mesh;constructor(){let e=new Vi(this.radius,24),t=e.getAttribute(`position`),n=new Float32Array(t.count*3),r=new Float32Array(t.count*3),i=new W,a=new q;for(let e=0;e<t.count;e++)i.set(t.getX(e),t.getY(e),t.getZ(e)).normalize(),r[e*3]=i.x,r[e*3+1]=i.y,r[e*3+2]=i.z,pu(i,a),n[e*3]=a.r,n[e*3+1]=a.g,n[e*3+2]=a.b;e.setAttribute(`normal`,new J(r,3)),e.setAttribute(`color`,new J(n,3)),this.mesh=new Y(e,Q({vertexColors:!0})),this.mesh.receiveShadow=!0,this.group.add(this.mesh)}surfacePoint(e,t=new W){return t.copy(e).multiplyScalar(this.radius)}scatter(e,t=[],n=150){let r=[{make:zl,weight:4},{make:Bl,weight:3},{make:Ul,weight:3},{make:Hl,weight:2},{make:Vl,weight:1}],i=r.reduce((e,t)=>e+t.weight,0),a=new W,o=0,s=0;for(;o<n&&s<n*12;){if(s++,a.copy($l(e)),!ou(a))continue;let n=!1;for(let e of t)if(a.angleTo(e)<.13){n=!0;break}if(n)continue;let c=e()*i,l=r[0].make;for(let e of r){if(c<e.weight){l=e.make;break}c-=e.weight}let u=l(e);eu(u,a,this.radius,e()*Math.PI*2),this.group.add(u),o++}}},hu=class{group=new wn;model=new wn;up=new W(0,1,0);forward=new W(0,0,1);right=new W(1,0,0);position=new W;radius=bl.planetRadius;basis=new Yt;q=new Dt;axis=new W;bobPhase=0;constructor(e){this.buildModel(),this.group.add(this.model),this.reset(e)}reset(e){this.up.copy(e).normalize(),this.forward.set(0,1,0),Math.abs(this.up.dot(this.forward))>.9&&this.forward.set(1,0,0),this.forward.addScaledVector(this.up,-this.forward.dot(this.up)).normalize(),this.bobPhase=0,this.sync(0,0)}update(e,t,n){n!==0&&(this.q.setFromAxisAngle(this.up,-n*bl.turnSpeed*e),this.forward.applyQuaternion(this.q));let r=0;if(t!==0){let n=t*bl.walkSpeed*e/this.radius;this.axis.copy(this.up).cross(this.forward).normalize(),this.q.setFromAxisAngle(this.axis,n),this.up.applyQuaternion(this.q),this.forward.applyQuaternion(this.q),r=Math.abs(t)}this.up.normalize(),this.forward.addScaledVector(this.up,-this.forward.dot(this.up)).normalize(),this.sync(e,r)}sync(e,t){this.right.copy(this.up).cross(this.forward).normalize(),this.position.copy(this.up).multiplyScalar(this.radius),this.group.position.copy(this.position),this.basis.makeBasis(this.right,this.up,this.forward),this.group.quaternion.setFromRotationMatrix(this.basis),this.bobPhase+=e*t*14;let n=t>0?Math.abs(Math.sin(this.bobPhase))*.12:0;this.model.position.y=n,this.model.rotation.z=t>0?Math.sin(this.bobPhase)*.05:0}buildModel(){let e=this.model,t=new Ri(.12,.12,.45,7);for(let n of[-1,1]){let r=new Y(t,Q({color:$.courierHat}));r.position.set(n*.17,.225,0),r.castShadow=!0,e.add(r)}let n=new Y(new Li(.7,.78,.46),Q({color:$.courierBody}));n.position.y=.84,n.castShadow=!0,e.add(n);let r=new Y(new Li(.58,.56,.3),Q({color:$.courierBag}));r.position.set(0,.92,-.34),r.castShadow=!0,e.add(r);let i=new Y(new Li(.12,.9,.5),Q({color:$.courierBag}));i.position.set(.12,.92,0),i.rotation.z=.18,e.add(i);let a=new Y(new Wi(.3,12,10),Q({color:$.courierSkin}));a.position.y=1.46,a.castShadow=!0,e.add(a);let o=new Y(new Ri(.34,.34,.07,14),Q({color:$.courierHat}));o.position.y=1.66,o.castShadow=!0,e.add(o);let s=new Y(new zi(.27,.34,14),Q({color:$.courierHat}));s.position.y=1.86,s.castShadow=!0,e.add(s);let c=new Y(new Wi(.07,8,6),Q({color:$.courierSkin}));c.position.set(0,1.42,.29),e.add(c),Dl(e,.025)}},gu=[$.roofA,$.roofB,$.roofC],_u=class{group=new wn;deliveries=[];activeIndex=0;constructor(e,t=bl.planetRadius){e.forEach((e,n)=>{let r=this.build(e.dir,e.name,t,n);this.deliveries.push(r),this.group.add(r.group)}),this.refreshVisibility()}get total(){return this.deliveries.length}get delivered(){return this.deliveries.filter(e=>e.done).length}get complete(){return this.delivered>=this.total}active(){return this.deliveries[this.activeIndex]??null}update(e,t,n){let r=this.active();return!r||r.done?null:(r.parcel.position.y=1.7+Math.sin(n*2)*.18,r.parcel.rotation.y+=t*1.2,r.ring.scale.setScalar(1+Math.sin(n*3)*.06),e.distanceTo(r.position)<=bl.deliverRadius?(r.done=!0,this.activeIndex++,this.refreshVisibility(),r):null)}reset(){this.activeIndex=0;for(let e of this.deliveries)e.done=!1,e.parcel.position.y=1.7,e.parcel.rotation.y=0,e.ring.scale.setScalar(1);this.refreshVisibility()}build(e,t,n,r){let i=new wn;eu(i,e,n);let a=gu[r%gu.length],o=Gl(a);i.add(o);let s=Kl(1.4,2,$.beacon);s.position.y=.02,i.add(s);let c=Wl(a);c.position.y=1.7,i.add(c);let l=Jl(t);l.position.y=2.7,i.add(l);let u=new Y(new Ri(.13,.13,8,12,1,!0),new ni({color:$.beacon,transparent:!0,opacity:.16,depthWrite:!1,side:2,blending:2}));return u.position.y=4,i.add(u),{dir:e.clone(),position:e.clone().multiplyScalar(n),name:t,group:i,ring:s,ringMat:s.material,parcel:c,label:l,pillar:u,done:!1}}refreshVisibility(){this.deliveries.forEach((e,t)=>{let n=t===this.activeIndex;e.done?(e.ringMat.color.set($.beaconDone),e.ringMat.opacity=.5):(e.ringMat.color.set($.beacon),e.ringMat.opacity=n?.55:.18),e.parcel.visible=n&&!e.done,e.pillar.visible=n&&!e.done,e.label.visible=n||e.done})}},vu=`
  varying vec3 vDir;
  void main() {
...
`;function bu(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.3,`rgba(255,250,230,0.9)`),n.addColorStop(1,`rgba(255,250,230,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Ni(e)}var xu=class{group=new wn;sunDirection=new W(.55,.72,.42).normalize();stars;starMaterial;domeMaterial;constructor(e=170){this.domeMaterial=new ea({uniforms:{topColor:{value:new q($.skyZenith)},midColor:{value:new q($.skyMid)},botColor:{value:new q($.skyHorizon)},sunColor:{value:new q($.sunGlow)},sunDir:{value:this.sunDirection}},vertexShader:vu,fragmentShader:yu,side:1,depthWrite:!1,fog:!1});let t=new Y(new Wi(e,32,24),this.domeMaterial);t.renderOrder=-1,this.group.add(t);let n=new Float32Array(720*3),r=new Float32Array(720*3),i=Zl(22436),a=new q($.star),o=new q(12571903),s=new q,c=e*.92;for(let e=0;e<720;e++){let t=$l(i);n[e*3]=t.x*c,n[e*3+1]=t.y*c,n[e*3+2]=t.z*c,s.copy(a).lerp(o,i()*.6),r[e*3]=s.r,r[e*3+1]=s.g,r[e*3+2]=s.b}let l=new Er;l.setAttribute(`position`,new J(n,3)),l.setAttribute(`color`,new J(r,3)),this.starMaterial=new Ti({size:2.2,map:bu(),vertexColors:!0,transparent:!0,depthWrite:!1,sizeAttenuation:!1,blending:2}),this.stars=new Ai(l,this.starMaterial),this.stars.renderOrder=-1,this.group.add(this.stars)}update(e,t){this.stars.rotation.y+=e*.006,this.starMaterial.opacity=.65+.3*Math.sin(t*.7)}},Su=`An original prototype — every shape, colour, and line of code is generated from primitives in this repository. No third-party game assets, source, or layouts are used or copied. Not affiliated with any existing game.`;function Cu(e,t={}){let n=document.createElement(e);return t.className&&(n.className=t.className),t.id&&(n.id=t.id),t.html!==void 0&&(n.innerHTML=t.html),n}var wu=class{onStart=()=>{};onReplay=()=>{};overlay;card;hud;objectiveText;objectiveHint;countDone;countTotal;compass;needle;dist;toast;touch;fwd=!1;back=!1;left=!1;right=!1;toastTimer=0;constructor(e){this.card=Cu(`div`,{className:`card`}),this.overlay=Cu(`div`,{className:`overlay`,id:`overlay`}),this.overlay.appendChild(this.card),this.hud=Cu(`div`,{id:`hud`}),this.hud.appendChild(Cu(`div`,{className:`hud-panel`,id:`hud-objective`,html:`<div class="label-tiny">Objective</div><div id="objective-text">Getting ready…</div><div id="objective-hint"></div>`})),this.hud.appendChild(Cu(`div`,{className:`hud-panel`,id:`hud-count`,html:`<div class="label-tiny">Delivered</div><div id="count-value"><span id="count-done">0</span><span class="total" id="count-total">/3</span></div>`})),this.compass=Cu(`div`,{id:`compass`,html:`<div class="ring"></div><div class="needle" id="needle"></div><div class="dist" id="dist">--</div>`}),this.toast=Cu(`div`,{id:`toast`}),this.touch=Cu(`div`,{id:`touch`,html:`<button class="touch-btn" id="t-fwd" aria-label="forward">▲</button><button class="touch-btn" id="t-back" aria-label="back">▼</button><button class="touch-btn" id="t-left" aria-label="left">◀</button><button class="touch-btn" id="t-right" aria-label="right">▶</button>`});let t=Cu(`div`,{className:`hint`,html:`WASD / arrow keys to move • reach the glowing mailbox to deliver`});e.append(this.overlay,this.hud,this.compass,this.toast,this.touch,t),this.objectiveText=this.req(`objective-text`),this.objectiveHint=this.req(`objective-hint`),this.countDone=this.req(`count-done`),this.countTotal=this.req(`count-total`),this.needle=this.req(`needle`),this.dist=this.req(`dist`),this.bindTouch(),window.matchMedia(`(pointer: coarse)`).matches&&document.body.classList.add(`touch`)}get touchMove(){return!!this.fwd-+!!this.back}get touchTurn(){return!!this.right-+!!this.left}get overlayVisible(){return!this.overlay.classList.contains(`hidden`)}showStart(){this.card.innerHTML=`<div class="art-preview"><img src="./concept-art.jpg" alt="Tiny planet courier concept art" /></div><h1>Tiny Planet Messenger</h1><div class="subtitle">A cozy courier run on a little world</div><p>Three parcels are waiting. Hop around your tiny planet and drop each one at its glowing mailbox. Follow the compass at the bottom of the screen.</p><div class="controls"><span class="key"><kbd>W</kbd><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd> / arrows — walk &amp; turn</span><span class="key"><kbd>Enter</kbd> — start</span></div><button class="btn" id="start-btn">Start delivering</button><p class="fine-print">${Su}</p>`,this.overlay.classList.remove(`hidden`),this.card.querySelector(`#start-btn`)?.addEventListener(`click`,()=>this.onStart())}showComplete(e,t){this.card.innerHTML=`<h1>All delivered! 🎉</h1><div class="subtitle">Tiny Planet Messenger</div><p>You delivered all ${e} parcels in <strong>${t}</strong>. The little world thanks you.</p><button class="btn" id="replay-btn">Play again</button>`,this.overlay.classList.remove(`hidden`),this.card.querySelector(`#replay-btn`)?.addEventListener(`click`,()=>this.onReplay())}hideOverlay(){this.overlay.classList.add(`hidden`)}showHud(e){this.hud.classList.toggle(`show`,e)}showCompass(e){this.compass.classList.toggle(`show`,e)}activateTouch(){this.touch.classList.add(`active`)}setObjective(e,t){this.objectiveText.textContent=e,this.objectiveHint.textContent=t}setCount(e,t){this.countDone.textContent=String(e),this.countTotal.textContent=`/${t}`}updateCompass(e,t){this.needle.style.transform=`translate(-50%, -100%) rotate(${e}deg)`,this.dist.textContent=`${Math.round(t)}m`}showToast(e){this.toast.textContent=e,this.toast.classList.add(`show`),window.clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>{this.toast.classList.remove(`show`)},1600)}req(e){let t=document.getElementById(e);if(!t)throw Error(`UI element #${e} missing`);return t}bindTouch(){let e=(e,t)=>{let n=this.req(e),r=e=>{e.preventDefault(),t(!0)},i=()=>t(!1);n.addEventListener(`pointerdown`,r),n.addEventListener(`pointerup`,i),n.addEventListener(`pointerleave`,i),n.addEventListener(`pointercancel`,i)};e(`t-fwd`,e=>this.fwd=e),e(`t-back`,e=>this.back=e),e(`t-left`,e=>this.left=e),e(`t-right`,e=>this.right=e)}},Tu=-10,Eu=104;function Du(e,t){return Ql(Tu+t/bl.planetRadius*Et.RAD2DEG,Eu+e/(bl.planetRadius*Math.cos(Tu*Et.DEG2RAD))*Et.RAD2DEG)}var Ou=Du(0,-24),ku=[{name:`Harbor Post`,dir:Du(30,-34)},{name:`Hill Shrine`,dir:Du(-42,26)},{name:`Forest Mill`,dir:Du(48,34)}];function Au(e){return Math.max(-1,Math.min(1,e))}function ju(e){return`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}var Mu=class{renderer;scene=new Nn;camera=new Pa(48,1,.1,500);clock=new eo;keyboard=new Ll;ui;sky=new xu;planet=new mu;player=new hu(Ou);quests=new _u(ku);tmp=new W;tmp2=new W;camTarget=new W;lookTarget=new W;running=!1;playing=!1;elapsed=0;playStartedAt=0;root;constructor(e){this.root=e,this.renderer=new yl({antialias:!0,alpha:!1}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setClearColor($.skyZenith,1),this.scene.background=new q($.skyZenith),this.scene.fog=new Mn($.skyZenith,.0055),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.root.appendChild(this.renderer.domElement),this.ui=new wu(e),this.ui.onStart=()=>this.beginRun(),this.ui.onReplay=()=>this.beginRun(),this.buildScene(),this.bindEvents(),this.resize(),this.updateHud(),this.ui.showStart()}start(){this.running||(this.running=!0,this.clock.start(),this.renderer.setAnimationLoop(()=>this.frame()))}dispose(){this.running=!1,this.renderer.setAnimationLoop(null),this.keyboard.dispose(),window.removeEventListener(`resize`,this.resize),this.renderer.dispose()}buildScene(){this.scene.add(this.sky.group);let e=new Sa($.hemiSky,$.hemiGround,2.1);this.scene.add(e);let t=new La($.sunLight,4.2);t.position.copy(this.sky.sunDirection).multiplyScalar(60),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.near=5,t.shadow.camera.far=140,t.shadow.camera.left=-28,t.shadow.camera.right=28,t.shadow.camera.top=28,t.shadow.camera.bottom=-28,this.scene.add(t),this.scene.add(this.planet.group),this.scene.add(this.quests.group),this.scene.add(this.player.group),this.planet.scatter(Zl(11256099),[Ou,...ku.map(e=>e.dir)],185),this.placeNeighborhoodDistrict(),this.placeAuthoredDetails(),this.placeCamera(1)}placeNeighborhoodDistrict(){let e=Zl(29097);for(let e=-54;e<=52;e+=4.2){let t=jl();t.scale.set(7,1,3.2),eu(t,Du(0,e),bl.planetRadius+.04,.05),this.scene.add(t)}for(let e of[-42,-24,-8,10,28,44])for(let t=-58;t<=58;t+=4.2){let n=jl();n.scale.set(6.4,1,3),eu(n,Du(t,e),bl.planetRadius+.045,Math.PI/2),this.scene.add(n)}for(let t of[{north:-48,easts:[-48,-36,-22,20,34,48],spin:.2},{north:-32,easts:[-54,-40,-26,18,32,50],spin:-.25},{north:-16,easts:[-46,-30,-16,16,30,46],spin:.35},{north:4,easts:[-54,-38,-20,20,38,54],spin:-.3},{north:22,easts:[-46,-30,-14,14,30,46],spin:.15},{north:40,easts:[-38,-22,22,38],spin:-.15}])for(let n of t.easts){let r=Vl(e);r.scale.setScalar(2.4+e()*.8),eu(r,Du(n,t.north),bl.planetRadius+.055,t.spin+(e()-.5)*.7),this.scene.add(r)}for(let e=0;e<18;e++){let t=e/18*Math.PI*2,n=Ml();n.scale.setScalar(1.8),eu(n,Du(Math.cos(t)*12,-10+Math.sin(t)*8),bl.planetRadius+.055,t),this.scene.add(n)}for(let[e,t,n]of[[-12,-24,.2],[12,-24,-.35],[-14,-8,.45],[14,-8,-.25],[-16,10,.2],[16,10,-.2]]){let r=Fl();r.scale.setScalar(1.35),eu(r,Du(e,t),bl.planetRadius+.06,n),this.scene.add(r)}}placeAuthoredDetails(){let e=[{dir:ku[0].dir,make:Ol,spin:-.35,scale:2.2},{dir:ku[1].dir,make:kl,spin:.55,scale:2},{dir:ku[2].dir,make:Al,spin:.1,scale:1.9}];for(let t of e){let e=t.make();e.scale.setScalar(t.scale),eu(e,t.dir,bl.planetRadius+.025,t.spin),this.scene.add(e)}let t=Nl();t.scale.setScalar(2.45),eu(t,Du(16,-4),bl.planetRadius+.03,-.9),this.scene.add(t);let n=Pl();n.scale.setScalar(1.65),eu(n,Du(-34,20),bl.planetRadius+.045,.35),this.scene.add(n);let r=Pl();r.scale.setScalar(1.32),eu(r,Du(-44,28),bl.planetRadius+.045,.5),this.scene.add(r);for(let e=0;e<12;e++){let t=e/11,n=Ou.clone().lerp(ku[0].dir,t).normalize(),r=jl();if(r.scale.setScalar(2.4+t*.55),eu(r,n,bl.planetRadius+.035,-.4+t*1.1),this.scene.add(r),e%3==1){let e=Fl();e.scale.setScalar(1.25),eu(e,n,bl.planetRadius+.055,-.4+t*1.1),this.scene.add(e)}}let i=[Du(-24,-18),Du(-8,-18),Du(8,-18),Du(24,-18),Du(-28,18),Du(28,18)];for(let e of i){let t=Ml();t.scale.setScalar(1.35),eu(t,e,bl.planetRadius+.04,Math.random()*Math.PI),this.scene.add(t)}}bindEvents(){window.addEventListener(`resize`,this.resize),window.addEventListener(`keydown`,e=>{e.code===`Enter`&&this.ui.overlayVisible&&(e.preventDefault(),this.beginRun())})}resize=()=>{let e=Math.max(1,this.root.clientWidth||window.innerWidth),t=Math.max(1,this.root.clientHeight||window.innerHeight);this.camera.aspect=e/t,this.camera.fov=e<700?58:48,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1)};beginRun(){this.player.reset(Ou),this.quests.reset(),this.elapsed=0,this.playStartedAt=this.clock.elapsedTime,this.playing=!0,this.ui.hideOverlay(),this.ui.showHud(!0),this.ui.showCompass(!0),this.ui.activateTouch(),this.ui.showToast(`First parcel loaded — follow the glow!`),this.updateHud(),this.placeCamera(1)}frame(){let e=Math.min(this.clock.getDelta(),.04);if(this.elapsed=this.clock.elapsedTime,this.sky.update(e,this.elapsed),this.playing){let t=Au(this.keyboard.move+this.ui.touchMove),n=Au(this.keyboard.turn+this.ui.touchTurn);this.player.update(e,t,n);let r=this.quests.update(this.player.position,e,this.elapsed);r&&(this.ui.showToast(`Delivered to ${r.name}!`),this.updateHud(),this.quests.complete&&(this.playing=!1,this.ui.showComplete(this.quests.total,ju(this.clock.elapsedTime-this.playStartedAt)),this.ui.showCompass(!1))),this.updateCompass()}this.placeCamera(e),this.renderer.render(this.scene,this.camera)}placeCamera(e){let t=e>=1?1:1-Math.exp(-bl.camLerp*e);this.camTarget.copy(this.player.position).addScaledVector(this.player.up,bl.camHeight).addScaledVector(this.player.forward,-bl.camDistance),this.camera.position.lerp(this.camTarget,t),this.lookTarget.copy(this.player.position).addScaledVector(this.player.up,1.55).addScaledVector(this.player.forward,bl.camLookAhead),this.camera.up.copy(this.player.up),this.camera.lookAt(this.lookTarget)}updateHud(){let e=this.quests.active();e?this.ui.setObjective(`Deliver parcel to ${e.name}`,`Look for the glowing mailbox beacon.`):this.ui.setObjective(`All routes complete`,`Replay to run the route again.`),this.ui.setCount(this.quests.delivered,this.quests.total)}updateCompass(){let e=this.quests.active();if(!e||(this.tmp.copy(e.dir).addScaledVector(this.player.up,-e.dir.dot(this.player.up)),this.tmp.lengthSq()<1e-6))return;this.tmp.normalize();let t=Et.clamp(this.tmp.dot(this.player.forward),-1,1),n=this.tmp.dot(this.player.right),r=Et.radToDeg(Math.atan2(n,t)),i=this.player.up.angleTo(e.dir)*bl.planetRadius;this.tmp2.copy(e.position).sub(this.player.position);let a=Math.min(i,this.tmp2.length());this.ui.updateCompass(r,a)}},Nu=document.querySelector(`#app`);if(!Nu)throw Error(`Missing #app mount point`);new Mu(Nu).start();